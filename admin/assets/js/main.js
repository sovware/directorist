...
(function ($) {
  ...
  $("#upgrade_directorist").on("click", function (event) {
    ...
    // display a notice to user to wait
    // send an ajax request to the back end
    atbdp_do_ajax($this, "atbdp_upgrade_old_listings", null, function (
      response
    ) {
      if (response.success) {
        $this.after("<p>" + response.data + "</p>");
  ...
  $('#shortcode-updated input[name="shortcode-updated"]').on(
    ...
    function (event) {
      ...
      // display a notice to user to wait
      // send an ajax request to the back end
      atbdp_do_ajax($this, "atbdp_upgrade_old_pages", null, function (
        response
      ) {
        if (response.success) {
  ...
  function atbdp_do_ajax(
    ...
    if (n < 0) {
      data =
        data + "&" + atbdp_admin_data.nonceName + "=" + atbdp_admin_data.nonce;
    }
...
jQuery(function ($) {
      ...
      if (multiple_image) {
        $(selection).each(function () {
          ...
          if ("image" === this.type) {
            ...
            data += '<div class="single_attachment">';
            data +=
              '<input class="listing_image_attachment" name="listing_img[]" type="hidden" value="' +
              this.id +
              '">';
            data +=
  ...
  /* // Display the media uploader when "Upload Image" button clicked in the custom taxonomy "atbdp_categories"
>>>>>>> 944c3285dca11f81a60879fcff00b34dff361230
...
<<<<<<< HEAD
        ...
        const lf_opt18 = $('#tagline_label,#display_tagline_for,#tagline_placeholder');
        lf_opt18.hide();
        ...
        // Display email notification
        const lf_opt36 = $(
                '#enable_featured_listing,#featured_listing_title,#featured_listing_desc,#featured_listing_price'
        );
        lf_opt36.hide();
...
=======
  ...
  lf_opt2.hide();
  $('input[name="search_result_filters_button_display"]').on(
    "change",
    function () {
      if ($(this).is(":checked") === true) {
        lf_opt2.show();
  ...
  if (
    $('input[name="search_result_filters_button_display"]').is(":checked") ===
    true
  ) {
    lf_opt2.show();
  }
  ...
  lf_opt4.hide();
  $(
    '#meta_title_for_search_result select[name="meta_title_for_search_result"]'
  ).on("change", function () {
    if ($(this).val() === "custom") {
      lf_opt4.show();
    } else {
  ...
  //Display form pricing
  var lf_opt19 = $(
    "#price_label,#require_price,#display_price_for,#price_placeholder"
  );
  lf_opt19.hide();
  $('input[name="display_pricing_field"]').on("change", function () {
    if ($(this).is(":checked") === true) {
  ...
  //Display social info
  var lf_opt26 = $(
    "#social_label,#require_social_info,#display_social_info_for"
  );
  lf_opt26.hide();
  $('input[name="display_social_info_field"]').on("change", function () {
    if ($(this).is(":checked") === true) {
  ...
  //Display terms and condition
  var lf_opt31 = $(
    "#require_terms_conditions, #terms_label, #terms_label_link"
  );
  lf_opt31.hide();
  $('input[name="listing_terms_condition"]').on("change", function () {
    if ($(this).is(":checked") === true) {
  ...
  //Display email notification
  var disable_email_notification = $(
    "#email_from_name,#email_from_email,#admin_email_lists,#notify_admin,#notify_user"
  );
  disable_email_notification.show();
  $('input[name="disable_email_notification"]').on("change", function () {
  ...
  //Display privacy fields in registration form
  var lf_registration_privacy = $(
    "#registration_privacy_label,#registration_privacy_label_link"
  );
  lf_registration_privacy.hide();
  $('input[name="registration_privacy"]').on("change", function () {
    if ($(this).is(":checked") === true) {
  ...
  //Display terms and conditions fields in registration form
  var lf_registration_terms = $(
    "#regi_terms_label,#regi_terms_label_link, #require_regi_terms_conditions"
  );
  lf_registration_terms.hide();
  $('input[name="regi_terms_condition"]').on("change", function () {
    if ($(this).is(":checked") === true) {
  ...
  //Display recover message in login form
  var lf_opt44 = $(
    "#recpass_text,#recpass_desc,#recpass_username,#recpass_placeholder,#recpass_button"
  );
  lf_opt44.hide();
  $('input[name="display_recpass"]').on("change", function () {
    if ($(this).is(":checked") === true) {
  ...
  //Display excerpt
  var lf_opt46 = $(
    "#excerpt_limit,#display_readmore,#excerpt_limit,#readmore_text"
  );
  lf_opt46.hide();
  $('input[name="enable_excerpt"]').on("change", function () {
    if ($(this).is(":checked") === true) {
  ...
  //Display popular categories
  var lf_opt49 = $(
    "#show_connector,#connectors_title,#popular_cat_title,#popular_cat_num"
  );
  lf_opt49.hide();
  $('input[name="show_popular_category"]').on("change", function () {
    if ($(this).is(":checked") === true) {
  ...
  //Display related listings
  var lf_opt52 = $(
    "#rel_listing_title,#rel_listing_num,#rel_listing_column,#rel_listings_logic"
  );
  lf_opt52.hide();
  $('input[name="enable_rel_listing"]').on("change", function () {
    if ($(this).is(":checked") === true) {
  ...
  //Display review rating
  var lf_opt61 = $(
    "#display_image_map, #display_title_map, #display_address_map, #display_direction_map"
  );
  lf_opt61.hide();
  $('input[name="display_map_info"]').on("change", function () {
    if ($(this).is(":checked") === true) {
  ...
  /* Copy shortcodes on click */
  var textToCopy = document.querySelectorAll(
    ".description.atbdp_settings_description strong"
  );
  textToCopy.forEach((el, index) => {
    el.addEventListener("click", function () {
      var $temp = $("<input>");
      ...
      $temp.remove();
      $(el).after(
        "<p style='color: #32cc6f; margin-top: 5px;'>Copied to clipboard!</p>"
      );
      setTimeout(function () {
        $(el)
          .siblings("p")
  ...
  // Single Slider - Display Background Type Options
  var single_slider_image_size_inp = $(
    'select[name="single_slider_image_size"]'
  );
  ...
  // Single Slider - Display Background Color Options
  var single_slider_background_type_inp = $(
    'select[name="single_slider_background_type"]'
  );
  var single_slider_background_color_wrap = $(
  ...
  // Single Slider - Display Dependency Options For Slider Image
  var dsiplay_slider_single_page_inp = $(
    'input[name="dsiplay_slider_single_page"]'
  );
  var dsiplay_slider_single_page_dep = $(
    "div#single_slider_image_size, div#dsiplay_thumbnail_img, div#gallery_crop_width, div#gallery_crop_height, div#single_slider_background_color"
  );
  ...
  if ($('select[name="button_type"]').val() === "solid_primary") {
    ...
    $('select[name="button_type"]').val() === "primary_outline_light"
  ) {
    primary_outline_light.show();
  } else if ($('select[name="button_type"]').val() === "danger_outline") {
    danger_outline.show();
