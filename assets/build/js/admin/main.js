...
window.addEventListener('load', function () {
  ...
  $('#atbdp-directorist-license-login-form').on('submit', function (e) {
    ...
    var form_data = {
      ...
      auth_method: form.find('input[name="auth_method"]').val() || 'account',
...
/*!**************************************!*\
  ...
  \**************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _global_global__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../global/global */ "./assets/src/js/global/global.js");
