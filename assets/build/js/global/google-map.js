...
/***/ "./assets/src/js/global/map-scripts/map-bridge.js":
/*!********************************************************!*\
  !*** ./assets/src/js/global/map-scripts/map-bridge.js ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   directoristMapBridge: function() { return /* binding */ directoristMapBridge; },
/* harmony export */   normalizeGoogleBounds: function() { return /* binding */ normalizeGoogleBounds; },
/* harmony export */   normalizeLeafletBounds: function() { return /* binding */ normalizeLeafletBounds; }
/* harmony export */ });
var EVENT_READY = 'directorist-map-ready';
var EVENT_VIEWPORT_CHANGED = 'directorist-map-viewport-changed';
var EVENT_MARKER_CLICK = 'directorist-map-marker-click';
function ensureBridge() {
  ...
  var bridge = {
    ...
    replaceMarkers: function replaceMarkers(instanceId, markers) {
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      var instance = this.get(instanceId);
      if (instance && typeof instance.replaceMarkers === 'function') {
        return instance.replaceMarkers(markers, options);
      }
      return false;
    },
    openPopup: function openPopup(instanceId, listingId, html) {
      var instance = this.get(instanceId);
    ...
    unregister: function unregister(instanceId) {
      if (instances[instanceId]) {
        delete instances[instanceId];
      }
    },
    dispatchReady: function dispatchReady(instanceId) {
      var instance = this.get(instanceId);
      if (!instance) {
        return;
      }
      this.dispatch(EVENT_READY, {
        ...
        bounds: typeof instance.getBounds === 'function' ? instance.getBounds() : null
      });
    },
    dispatchViewportChanged: function dispatchViewportChanged(instanceId) {
      var instance = this.get(instanceId);
      if (!instance) {
        return;
      }
    ...
    dispatchMarkerClick: function dispatchMarkerClick(instanceId, listingId) {
      var instance = this.get(instanceId);
...
function directoristMapBridge() {
  return ensureBridge();
}
function normalizeGoogleBounds(map) {
...
function normalizeLeafletBounds(map) {
  if (!map || typeof map.getBounds !== 'function') {
    return null;
  }
  var bounds = map.getBounds();
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../../lib/helper */ "./assets/src/js/lib/helper.js");
/* harmony import */ var _map_bridge__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./map-bridge */ "./assets/src/js/global/map-scripts/map-bridge.js");
/* harmony import */ var _add_listing_google_map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./add-listing/google-map */ "./assets/src/js/global/map-scripts/add-listing/google-map.js");
/* harmony import */ var _single_listing_google_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./single-listing/google-map */ "./assets/src/js/global/map-scripts/single-listing/google-map.js");
/* harmony import */ var _single_listing_google_map_widget__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./single-listing/google-map-widget */ "./assets/src/js/global/map-scripts/single-listing/google-map-widget.js");
  ...
  function initMap() {
    ...
    (function ($) {
      ...
      function atbdp_rander_map($el) {
        ...
        var bridge = (0,_map_bridge__WEBPACK_IMPORTED_MODULE_1__.directoristMapBridge)();
        var instanceId = $el.data('directorist-map-instance') || $el.attr('id') || "directorist-map-".concat(Date.now());
        ...
        google.maps.event.addListener(map, 'dragstart', markUserInteraction);
        ...
        bridge.register({
          ...
          getBounds: function getBounds() {
            return (0,_map_bridge__WEBPACK_IMPORTED_MODULE_1__.normalizeGoogleBounds)(map);
          },
          openPopup: function openPopup(listingId, html) {
            var marker = map.markers.find(function (item) {
              return parseInt(item.directoristListingId, 10) === parseInt(listingId, 10);
            });
            if (!marker) {
              return false;
            }
            infowindow.setContent(html || marker.directoristInfoHtml || '');
      ...
      function atbdp_add_marker($marker, map, infowindow, instanceId) {
        ...
        var listingId = parseInt($marker.data('listing-id'), 10) || 0;
        ...
        if ($marker.html()) {
          ...
          google.maps.event.addListener(marker, 'click', function () {
            (0,_map_bridge__WEBPACK_IMPORTED_MODULE_1__.directoristMapBridge)().dispatchMarkerClick(instanceId, listingId);
...
window.directoristLoadGoogleMap = function () {
  if (typeof google === 'undefined' || !google.maps || !google.maps.Map) {
    ...
    (0,_single_listing_google_map__WEBPACK_IMPORTED_MODULE_3__.initSingleMap)();
    (0,_add_listing_google_map__WEBPACK_IMPORTED_MODULE_2__.initAddListingMap)();
    (0,_single_listing_google_map_widget__WEBPACK_IMPORTED_MODULE_4__.initSingleMapWidget)();
  }
};
}();
/******/ })()
