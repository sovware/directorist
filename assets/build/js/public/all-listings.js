...
(function ($) {
  ...
  */
  ...
  function closeAllSearchModal() {
    var searchModalElements = document.querySelectorAll('.directorist-search-modal');
    searchModalElements.forEach(function (modal) {
      modal.dispatchEvent(new CustomEvent('directorist-search-modal-close', {
        bubbles: true
      }));
    });
  }
  ...
  */
  ...
  var dateTimeInputSelector = ".directorist-instant-search .listing-with-sidebar input[type='time'], .directorist-instant-search .listing-with-sidebar input[type='date']";
  var performDateTimeInstantSearch = (0,_global_components_debounce__WEBPACK_IMPORTED_MODULE_3__["default"])(function (input) {
