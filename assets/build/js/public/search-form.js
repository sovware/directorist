...
/***/ "./assets/src/js/public/components/searchModal.js":
/*!********************************************************!*\
  !*** ./assets/src/js/public/components/searchModal.js ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   closeSearchModal: function() { return /* binding */ closeSearchModal; },
/* harmony export */   initSearchModals: function() { return /* binding */ initSearchModals; },
/* harmony export */   openSearchModal: function() { return /* binding */ openSearchModal; }
/* harmony export */ });
var activeSearchModal = null;
var activeSearchModalTrigger = null;
var searchModalScrollPosition = 0;
var searchModalInitialized = false;
function setSearchModalPageState(isOpen) {
  var contentRoot = document.querySelector(".directorist-content-active");
  if (isOpen) {
    searchModalScrollPosition = window.scrollY;
    document.body.style.setProperty("--directorist-search-modal-scroll-offset", "-".concat(searchModalScrollPosition, "px"));
  }
  contentRoot === null || contentRoot === void 0 || contentRoot.classList.toggle("directorist-overlay-active", isOpen);
  document.documentElement.classList.toggle("directorist-search-modal-open", isOpen);
  document.body.classList.toggle("directorist-search-modal-open", isOpen);
  if (isOpen) {
    return;
  }
  document.body.style.removeProperty("--directorist-search-modal-scroll-offset");
  window.scrollTo(0, searchModalScrollPosition);
}
function getSearchModalFocusableElement(modalContent) {
  return modalContent.querySelector('input:not([type="hidden"]):not([disabled]), select:not([disabled]), textarea:not([disabled])') || modalContent.querySelector("button:not([disabled]), a[href]");
}
function openSearchModal(searchModalParent, trigger) {
  var _activeSearchModalTri;
  ...
  (_activeSearchModalTri = activeSearchModalTrigger) === null || _activeSearchModalTri === void 0 || _activeSearchModalTri.setAttribute("aria-expanded", "true");
  setSearchModalPageState(true);
  var focusTarget = getSearchModalFocusableElement(modalContent);
  var focusSearchControl = function focusSearchControl() {
...
function closeSearchModal(searchModalParent) {
  var restoreFocus = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  if (!searchModalParent) {
    return;
  }
  var modalContent = searchModalParent.querySelector(".directorist-search-modal__contents");
  ...
  modalContent === null || modalContent === void 0 || modalContent.removeAttribute("style");
  modalContent === null || modalContent === void 0 || modalContent.removeAttribute("aria-modal");
  modalMinimizer === null || modalMinimizer === void 0 || modalMinimizer.classList.remove("minimized");
  if (activeSearchModal === searchModalParent) {
    var trigger = activeSearchModalTrigger;
    trigger === null || trigger === void 0 || trigger.setAttribute("aria-expanded", "false");
...
function initSearchModalSwipeDismiss() {
  document.querySelectorAll(".directorist-search-modal__contents").forEach(function (modalContent) {
    var swipeHandle = modalContent.querySelector(".directorist-search-modal__contents__header") || modalContent.querySelector(".directorist-search-modal__minimizer");
    ...
    var touchDistance = 0;
    swipeHandle.addEventListener("touchstart", function (event) {
      if (!window.matchMedia("(max-width: 575px)").matches || event.touches.length !== 1) {
        return;
      }
    ...
    swipeHandle.addEventListener("touchmove", function (event) {
      if (null === touchStartY || event.touches.length !== 1) {
        return;
      }
      touchDistance = Math.max(0, event.touches[0].clientY - touchStartY);
      modalContent.style.transform = "translate(-50%, ".concat(touchDistance, "px)");
    }, {
      passive: true
    });
    swipeHandle.addEventListener("touchend", function () {
      var searchModalParent = modalContent.closest(".directorist-search-modal");
...
function initSearchModals() {
  ...
  document.addEventListener("directorist-search-modal-close", function (event) {
    var searchModalParent = event.target.closest(".directorist-search-modal");
    if (searchModalParent) {
      closeSearchModal(searchModalParent);
    }
  });
...
/* harmony import */ var _components_searchModal__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/searchModal */ "./assets/src/js/public/components/searchModal.js");
  ...
  window.addEventListener('load', function () {
    ...
    function adsFormReset(searchForm) {
      ...
      searchForm.querySelectorAll('.directorist-search-basic-dropdown-content').forEach(function (dropdown) {
        ...
        $(dropdown).siblings('.directorist-search-basic-dropdown-label').find('.directorist-search-basic-dropdown-selected-prefix, .directorist-search-basic-dropdown-selected-item').text('');
    ...
    if ($('.directorist-btn-reset-js') !== null) {
      $('body').on('click', '.directorist-btn-reset-js', function (e) {
        ...
        var resetTargets = new Set();
        var searchModal = this.closest('.directorist-search-modal');
        if (searchModal) {
          resetTargets.add(searchModal);
          searchModal.querySelectorAll("input[type='checkbox'], input[type='radio']").forEach(function (input) {
            var _input$closest;
            input.checked = false;
            (_input$closest = input.closest('.directorist-search-field')) === null || _input$closest === void 0 || _input$closest.classList.remove('input-has-value', 'input-is-focused');
          });
          searchModal.querySelectorAll('select').forEach(function (select) {
            var _select$closest;
            select.selectedIndex = 0;
            (_select$closest = select.closest('.directorist-search-field')) === null || _select$closest === void 0 || _select$closest.classList.remove('input-has-value', 'input-is-focused');
            $(select).trigger('change');
          });
        }
        var contentsWrap = this.closest('.directorist-contents-wrap');
        if (contentsWrap) {
          var _searchForm = contentsWrap.querySelector('.directorist-search-form');
          if (_searchForm) {
            resetTargets.add(_searchForm);
          }
    ...
    function searchModalOpen(searchModalParent, trigger) {
      ;(0,_components_searchModal__WEBPACK_IMPORTED_MODULE_12__.openSearchModal)(searchModalParent, trigger);
    }

    // Search Modal Close
    function searchModalClose(searchModalParent) {
      ;(0,_components_searchModal__WEBPACK_IMPORTED_MODULE_12__.closeSearchModal)(searchModalParent);
    }
    ...
    ;(0,_components_searchModal__WEBPACK_IMPORTED_MODULE_12__.initSearchModals)();
    ...
    $('body').on('click', '.directorist-modal-btn', function (e) {
      ...
      if (this.classList.contains('directorist-modal-btn--advanced')) {
        ...
        searchModalOpen(_searchModalElement, this);
      }
      if (this.classList.contains('directorist-modal-btn--full')) {
        ...
        searchModalOpen(_searchModalElement2, this);
      }
    });
