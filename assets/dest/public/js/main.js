...
(function ($) {
  ...
  function atbdp_do_ajax(ElementToShowLoadingIconAfter, ActionName, arg, CallBackHandler) {
    ...
    if (n < 0) {
      data = "".concat(data, "&").concat(atbdp_add_listing.nonceName, "=").concat(atbdp_add_listing.nonce);
    }
  ...
  var createLoc = atbdp_add_listing.create_new_loc;
...
})(jQuery); // Custom Image uploader for listing image (multiple)
...
jQuery(function ($) {
  ...
  var uploaders = atbdp_add_listing.media_uploader;
  var mediaUploaders = [];
