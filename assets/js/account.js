/******/ (function () {
			...
			/***/ function () {
				...
				function modalToggle() {
					...
					function restoreModalToOriginalPosition(modalElement) {
						if (
							!modalElement ||
							!modalOriginalParents.has(modalElement)
						) {
							return;
						}
						var originalData =
							modalOriginalParents.get(modalElement);
					...
					$(document).bind('click', function (e) {
						...
						var clickedModal = $(e.target).closest(
							'.directorist-modal-js'
						);
						if (
							clickedModal.length &&
							e.target === clickedModal[0]
						) {
							// Hide modal
				...
				jQuery(function ($) {
					...
					$('.directorist-authentication__btn').on(
						...
						function () {
							...
							$('.directorist__authentication__signup').each(
								function () {
									this.reset(); // Reset the individual form
								}
							);
  ...
  \*************************************************/
		...
		/* harmony import */ var _components_directoristAlert__WEBPACK_IMPORTED_MODULE_0__ =
			__webpack_require__(
				/*! ../components/directoristAlert */ './assets/src/js/public/components/directoristAlert.js'
			);
		/* harmony import */ var _components_directoristAlert__WEBPACK_IMPORTED_MODULE_0___default =
			/*#__PURE__*/ __webpack_require__.n(
				_components_directoristAlert__WEBPACK_IMPORTED_MODULE_0__
			);
		...
		/* harmony import */ var _components_login__WEBPACK_IMPORTED_MODULE_1___default =
			/*#__PURE__*/ __webpack_require__.n(
				_components_login__WEBPACK_IMPORTED_MODULE_1__
			);
		/* harmony import */ var _components_reset_password__WEBPACK_IMPORTED_MODULE_2__ =
			__webpack_require__(
				/*! ../components/reset-password */ './assets/src/js/public/components/reset-password.js'
			);
		/* harmony import */ var _components_reset_password__WEBPACK_IMPORTED_MODULE_2___default =
			/*#__PURE__*/ __webpack_require__.n(
				_components_reset_password__WEBPACK_IMPORTED_MODULE_2__
			);
		/* harmony import */ var _components_register_form__WEBPACK_IMPORTED_MODULE_3__ =
			__webpack_require__(
				/*! ../components/register-form */ './assets/src/js/public/components/register-form.js'
			);
		/* harmony import */ var _components_register_form__WEBPACK_IMPORTED_MODULE_3___default =
			/*#__PURE__*/ __webpack_require__.n(
				_components_register_form__WEBPACK_IMPORTED_MODULE_3__
			);
		...
		/* harmony import */ var _global_components_modal__WEBPACK_IMPORTED_MODULE_4___default =
			/*#__PURE__*/ __webpack_require__.n(
				_global_components_modal__WEBPACK_IMPORTED_MODULE_4__
			);
		// General Components
	})();
	/******/
