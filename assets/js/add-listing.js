...
$(function () {
  ...
  function renderCategoryCustomFields() {
    if ((0,_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_2__["default"])(localized_data === null || localized_data === void 0 ? void 0 : localized_data.category_custom_field_relations) !== 'object') {
      return;
    }
    var categoryIds = [];
    var directoryId = 0;
    ...
    var stringCategoryIds = new Set((0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(categoryIds).map(function (id) {
      return String(id);
    }));
  ...
  $('body').on('submit', '#directorist-add-listing-form', function (e) {
    ...
    function submitForm($form) {
      ...
      $.ajax({
        ...
        url: localized_data.ajaxurl,
        data: form_data,
        headers: (0,_helper__WEBPACK_IMPORTED_MODULE_4__.directoristRequestHeaders)(),
        beforeSend: function beforeSend() {
          disableSubmitButton();
