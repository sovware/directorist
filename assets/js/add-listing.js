/******/ (function () {
  ...
  \*********************************************/
		...
		/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_4__ =
			__webpack_require__(/*! ../helper */ './assets/src/js/helper.js');
		/* harmony import */ var _public_components_colorPicker__WEBPACK_IMPORTED_MODULE_5__ =
			__webpack_require__(
				/*! ../public/components/colorPicker */ './assets/src/js/public/components/colorPicker.js'
			);
		/* harmony import */ var _public_components_colorPicker__WEBPACK_IMPORTED_MODULE_5___default =
			/*#__PURE__*/ __webpack_require__.n(
				_public_components_colorPicker__WEBPACK_IMPORTED_MODULE_5__
			);
		/* harmony import */ var _public_components_directoristDropdown__WEBPACK_IMPORTED_MODULE_6__ =
			__webpack_require__(
				/*! ../public/components/directoristDropdown */ './assets/src/js/public/components/directoristDropdown.js'
			);
		/* harmony import */ var _public_components_directoristDropdown__WEBPACK_IMPORTED_MODULE_6___default =
			/*#__PURE__*/ __webpack_require__.n(
				_public_components_directoristDropdown__WEBPACK_IMPORTED_MODULE_6__
			);
		/* harmony import */ var _public_components_directoristSelect__WEBPACK_IMPORTED_MODULE_7__ =
			__webpack_require__(
				/*! ../public/components/directoristSelect */ './assets/src/js/public/components/directoristSelect.js'
			);
		/* harmony import */ var _public_components_directoristSelect__WEBPACK_IMPORTED_MODULE_7___default =
			/*#__PURE__*/ __webpack_require__.n(
				_public_components_directoristSelect__WEBPACK_IMPORTED_MODULE_7__
			);
		...
		$(function () {
			...
			function renderCategoryCustomFields() {
				...
				for (
					...
					var shouldShow = categoryId.some(function (id) {
						return stringCategoryIds.has(id);
					});
					if (shouldShow) {
				...
				function (e) {
					...
					function submitForm($form) {
						...
						$.ajax({
							...
							data: form_data,
							headers: (0,
							_helper__WEBPACK_IMPORTED_MODULE_4__.directoristRequestHeaders)(),
							beforeSend: function beforeSend() {
								disableSubmitButton();
								$notification
									.show()
