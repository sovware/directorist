	...
	!(function () {
		...
		function s() {
			...
			[
				...
				u(a(a({}, { taxonomy: 'tags' }), e));
		}
		function d(t) {
			u(a(a({}, { taxonomy: 'categories' }), t));
		}
		function l(t) {
			u(a(a({}, { taxonomy: 'locations' }), t));
		}
		function u(t) {
			if (
				(t = a(a({}, { selector: '', url: '', taxonomy: 'tags' }), t))
					.selector
			) {
				var e = c(t.selector),
					...
					o = 0;
				if ('tags' !== t.taxonomy) {
					var s = e.closest('.directorist-search-form'),
		...
		function f() {
			if (
				...
				var t = {};
				for (var i in window.directorist.request_headers)
					t['Directorist-'.concat(i)] =
						window.directorist.request_headers[i];
				return t;
			}
			return {};
		}
		...
		window.addEventListener('load', s),
			...
			i(5386);
		var h = jQuery,
			_ = directorist.add_listing_data;
		function v() {
			return _.is_admin ? '#post' : '#directorist-add-listing-form';
		}
		function g() {
			var t = h('.directorist-color-field-js', v());
		...
		h(window).on('load', function () {
			...
			h(function () {
				...
				if (
					...
					h('body').on('click', '#addNewSocial', function (t) {
						var e = this,
							...
							r = h('.directorist-form-social-fields').length,
							n = 'id='.concat(r),
					...
					h('body').on(
						...
						function (t) {
							...
							swal(
								{
									title: _.i18n_text.confirmation_text,
									text: _.i18n_text.ask_conf_sl_lnk_del_txt,
									type: 'warning',
									showCancelButton: !0,
									confirmButtonColor: '#DD6B55',
									confirmButtonText:
										_.i18n_text.confirm_delete,
									closeOnConfirm: !1,
								},
								function (t) {
									t &&
				...
				function a() {
					if (
						...
						e(
							null == _
								? void 0
								: _.category_custom_field_relations
						)
					) {
						var i = [],
							r = 0,
							n = _.category_custom_field_relations,
						...
						if (
							...
							void 0 !== n[r] && 0 !== n[r].length)
						) {
							var a = h(o);
							a.length &&
								(i = a.toArray().map(function (t) {
									return Number(t.value);
								}));
							var c = { hide: new Set(), show: new Set() };
							i = new Set(i);
							for (
								var s = 0, d = Object.entries(n[r]);
								s < d.length;
								s++
							) {
								var l =
									...
									g = m.closest('.directorist-form-group');
								i.has(f)
				...
				if (_.media_uploader) {
					var s,
						d = p(_.media_uploader);
					try {
						for (d.s(); !(s = d.n()).done; ) {
							var l = s.value;
							if (h('.' + l.element_id).length) {
				...
				h('body').on(
					...
					function (t) {
						...
						var e = h(t.target),
							i = {},
							r = h('.directorist-form-submit__btn');
						if (!S) {
							var n = [],
								a = [];
							if (c.length)
							...
							if (n.length) {
								...
								a.length === n.length ? g(e, a) : b();
							} else g(e);
						}
						function m() {
							(S = !0),
								r.addClass('atbd_loading').attr('disabled', !0);
						}
						function v() {
							(S = !1),
								r
						...
						function g(t) {
							...
							var b = t.find('#at_biz_dir-categories').val();
							...
							'string' == typeof b &&
								n.append('tax_input[at_biz_dir-category][]', b),
							...
							var S = t.find("input[name='directory_type']"),
								j = void 0 !== S ? S.val() : '',
								C = o.directory_type ? o.directory_type : j;
							if (
								(n.append('directory_type', C),
							...
							h.ajax({
								...
								beforeSend: function () {
									m(),
										A.show().html(
											'<span class="atbdp_success">'.concat(
												_.i18n_text.submission_wait_msg,
												'</span>'
											)
										);
								},
						...
						h('.directorist-custom-field-btn-more').length &&
							h('.directorist-custom-field-btn-more').each(
								function (t, e) {
									...
									h(r).slice(20, r.length).hide(),
										r.length <= 20 && h(e).hide();
								}
							);
					}),
					h('body').on(
						...
						function (t) {
							...
							h(i).slice(20, i.length).slideUp(),
								...
								h(this).hasClass('active')
									? (h(this).text(_.i18n_text.see_less_text),
										h(i).slice(20, i.length).slideDown())
									: (h(this).text(_.i18n_text.see_more_text),
										h(i).slice(20, i.length).slideUp());
						}
					),
					...
					h(window).scroll(
						((m = function () {
							var t = h(window).width(),
								...
								n = h('.multistep-wizard').outerHeight();
							if (t > 991) {
