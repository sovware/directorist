			...
			33679: function () {
				...
				function r() {
					(!(function () {
						...
						var t = n('.select2-hidden-accessible');
						if (t) {
							if (
			...
			if (
				...
				if ('tags' !== t.taxonomy) {
					...
					(a.length &&
						...
						u &&
							u.length &&
							(n = Number(u.data('listing_type_id'))),
						l.length && (n = l.val()),
						n && (n = Number(n)));
				}
				var f = 1,
					p = {
						...
						templateResult: function (t) {
							if (!t.id) return t.text;
							var e = s(t.element).attr('data-icon'),
								i = t.text,
								r = i.match(/^\s+/),
								o = r ? r[0].length : 0;
							i = i.trim();
					...
					function m(t, e, i) {
						if (t.length && e) {
							...
							r.forEach(function (e, i) {
								var r = o.length >= i + 1 ? o[i] : '',
									n = new Option(r, e, !0, !0);
								(t.append(n),
									t.trigger({
										type: 'select2:select',
				...
				(r && (r.innerHTML = n),
					...
					_('.multistep-wizard__btn--prev').on('click', function (t) {
						(t.preventDefault(),
							n > 1 &&
								(c(--n),
								n <= 1 && this.setAttribute('disabled', !0)));
					}),
					_('.multistep-wizard__btn--next').on('click', function (t) {
						(t.preventDefault(), n < e.length && c(++n));
					}),
			...
			_(function () {
				...
				function a() {
					if (
						...
						var t = [],
							i = 0,
							o = v.category_custom_field_relations,
							n = directorist.is_admin
				...
				(_('body').on(
					...
					function (t) {
						if ((t.preventDefault(), !S)) {
							var e = _(t.target),
								i = {},
								r = e.find('.directorist-form-submit__btn'),
								o = [],
								a = 0,
								s = e.find("input[name='directory_type']"),
								d = void 0 !== s ? s.val() : 0;
							if (
								((d = n.directory_type ? n.directory_type : d),
								c.length)
							)
							...
							if (o.length) {
								function x() {
									if (!A.has(o[a].file)) {
										var t = new FormData();
										(t.append('file', o[a].file),
											t.append('field', o[a].field),
											t.append('directory', d),
											_.ajax({
												method: 'POST',
												processData: !1,
												contentType: !1,
						...
						function w(t) {
							var e =
								...
								r = {},
								o = new FormData();
							(o.append('action', 'add_listing_action'),
								o.append(
									'directorist_nonce',
									directorist.directorist_nonce
								),
							...
							var x = t.find('#at_biz_dir-categories').val();
							...
							if (
								...
								o.has('admin_category_select[]') &&
									o.delete('admin_category_select[]'),
								o.has('directory_type') &&
									o.delete('directory_type'),
								o.append('directory_type', d),
								n.plan && o.append('plan_id', n.plan),
								n.order && o.append('order_id', n.order),
								i)
							)
								return (
									g(),
					...
					_(window).scroll(
						((f = function () {
							var t = _(window).width(),
								...
								o = _('.multistep-wizard').outerHeight();
							if (t > 991) {
