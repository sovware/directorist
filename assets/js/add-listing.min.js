					...
					function (t) {
						if ((t.preventDefault(), !k)) {
							var e = h(t.target),
								...
								d = void 0 !== s ? s.val() : 0;
							if (
								((d = o.directory_type ? o.directory_type : d),
								c.length)
							)
							...
							if (n.length) {
								function b() {
									if (!C.has(n[a].file)) {
										var t = new FormData();
										(t.append('file', n[a].file),
											t.append('field', n[a].field),
