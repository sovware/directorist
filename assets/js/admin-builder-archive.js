/******/ (function () {
  ...
  \******************************************************************/
			/***/ function () {
				window.addEventListener('load', function () {
					...
					// Open Delete Modal
					$('.atbdp-directory-delete-link-action').on(
						'click',
						function (e) {
							e.preventDefault();
							var delete_link = $(this).data('delete-link');
							$('.atbdp-directory-delete-link').prop(
								'href',
								delete_link
							);
						}
					...
					$('.atbdp-directory-delete-link').on('click', function (e) {
						...
						$('.atbdp-directory-delete-cancel-link').addClass(
							'atbdp-disabled'
						);
					});
				});
			...
			/***/ function (
				...
				window.addEventListener('load', function () {
					...
					var axios = __webpack_require__(
						/*! axios */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/index.js'
					)['default'];

					// Migration Link
					$('.atbdp-directory-migration-link').on(
						'click',
						function (e) {
							e.preventDefault();
							var self = this;
							$('.cptm-directory-migration-form')
								...
								.html('Please wait...');
							$(
								'.atbdp-directory-migration-cencel-link'
							).remove();
							$(this).html(
							...
							var responseFaildCallback =
								function responseFaildCallback(response) {
			...
			/***/ function (
				...
				window.addEventListener('load', function () {
					...
					$('.cptm-import-directory-form').on('submit', function (e) {
						...
						var modal_content = $(
							'.cptm-import-directory-modal'
						).find('.cptm-modal-content');
						var modal_alert = $(
							'.cptm-import-directory-modal-alert'
						);
						var form_data = new FormData();
						form_data.append(
							'action',
							'save_imported_post_type_data'
						);
						form_data.append(
							'directorist_nonce',
						...
						axios
							...
							.then(function (response) {
								...
								$(self)
									.find(
										'button[type=submit] .cptm-loading-icon'
									)
								...
								if (
									response.data &&
									response.data.status.status_log
								) {
									var status_log =
										response.data.status.status_log;
  ...
  \*********************************************************************/
			/***/ function (
				...
				module.exports = __webpack_require__(
					/*! ./lib/axios */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/axios.js'
				);
  ...
  \********************************************************************************/
			/***/ function (
				...
				var utils = __webpack_require__(
					/*! ./../utils */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/utils.js'
				);
				var settle = __webpack_require__(
					/*! ./../core/settle */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/core/settle.js'
				);
				var cookies = __webpack_require__(
					/*! ./../helpers/cookies */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/helpers/cookies.js'
				);
				var buildURL = __webpack_require__(
					/*! ./../helpers/buildURL */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/helpers/buildURL.js'
				);
				var buildFullPath = __webpack_require__(
					/*! ../core/buildFullPath */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/core/buildFullPath.js'
				);
				var parseHeaders = __webpack_require__(
					/*! ./../helpers/parseHeaders */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/helpers/parseHeaders.js'
				);
				var isURLSameOrigin = __webpack_require__(
					/*! ./../helpers/isURLSameOrigin */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/helpers/isURLSameOrigin.js'
				);
				var createError = __webpack_require__(
					/*! ../core/createError */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/core/createError.js'
				);
  ...
  \*************************************************************************/
			/***/ function (
				...
				var bind = __webpack_require__(
					/*! ./helpers/bind */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/helpers/bind.js'
				);
				var Axios = __webpack_require__(
					/*! ./core/Axios */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/core/Axios.js'
				);
				var mergeConfig = __webpack_require__(
					/*! ./core/mergeConfig */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/core/mergeConfig.js'
				);
				var defaults = __webpack_require__(
					/*! ./defaults */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/defaults.js'
				);
				...
				axios.Cancel = __webpack_require__(
					/*! ./cancel/Cancel */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/cancel/Cancel.js'
				);
				axios.CancelToken = __webpack_require__(
					/*! ./cancel/CancelToken */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/cancel/CancelToken.js'
				);
				axios.isCancel = __webpack_require__(
					/*! ./cancel/isCancel */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/cancel/isCancel.js'
				);
				...
				axios.spread = __webpack_require__(
					/*! ./helpers/spread */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/helpers/spread.js'
				);

				// Expose isAxiosError
				axios.isAxiosError = __webpack_require__(
					/*! ./helpers/isAxiosError */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/helpers/isAxiosError.js'
				);
  ...
  \**************************************************************************************/
			/***/ function (
				...
				var Cancel = __webpack_require__(
					/*! ./Cancel */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/cancel/Cancel.js'
				);
  ...
  \******************************************************************************/
			/***/ function (
				...
				var InterceptorManager = __webpack_require__(
					/*! ./InterceptorManager */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/core/InterceptorManager.js'
				);
				var dispatchRequest = __webpack_require__(
					/*! ./dispatchRequest */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/core/dispatchRequest.js'
				);
				var mergeConfig = __webpack_require__(
					/*! ./mergeConfig */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/core/mergeConfig.js'
				);
				var validator = __webpack_require__(
					/*! ../helpers/validator */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/helpers/validator.js'
				);
  ...
  \**************************************************************************************/
			/***/ function (
				...
				var isAbsoluteURL = __webpack_require__(
					/*! ../helpers/isAbsoluteURL */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/helpers/isAbsoluteURL.js'
				);
				var combineURLs = __webpack_require__(
					/*! ../helpers/combineURLs */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/helpers/combineURLs.js'
				);
  ...
  \************************************************************************************/
			/***/ function (
				...
				var enhanceError = __webpack_require__(
					/*! ./enhanceError */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/core/enhanceError.js'
				);
  ...
  \****************************************************************************************/
			/***/ function (
				...
				var transformData = __webpack_require__(
					/*! ./transformData */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/core/transformData.js'
				);
  ...
  \*******************************************************************************/
			/***/ function (
				...
				var createError = __webpack_require__(
					/*! ./createError */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/core/createError.js'
				);
  ...
  \****************************************************************************/
			/***/ function (
				...
				var normalizeHeaderName = __webpack_require__(
					/*! ./helpers/normalizeHeaderName */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/helpers/normalizeHeaderName.js'
				);
				var enhanceError = __webpack_require__(
					/*! ./core/enhanceError */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/core/enhanceError.js'
				);
				...
				function getDefaultAdapter() {
					...
					if (typeof XMLHttpRequest !== 'undefined') {
						...
						adapter = __webpack_require__(
							/*! ./adapters/xhr */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/adapters/xhr.js'
						);
					} else if (
						...
						adapter = __webpack_require__(
							/*! ./adapters/http */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/lib/adapters/xhr.js'
						);
					}
					return adapter;
				}
  ...
  \*************************************************************************************/
			/***/ function (
				...
				var pkg = __webpack_require__(
					/*! ./../../package.json */ './node_modules/.pnpm/axios@0.21.4/node_modules/axios/package.json'
				);
  ...
  \********************************************************/
		...
		/* harmony import */ var _components_delete_directory_modal__WEBPACK_IMPORTED_MODULE_0__ =
			__webpack_require__(
				/*! ./components/delete-directory-modal */ './assets/src/js/admin/components/delete-directory-modal.js'
			);
		/* harmony import */ var _components_delete_directory_modal__WEBPACK_IMPORTED_MODULE_0___default =
			/*#__PURE__*/ __webpack_require__.n(
				_components_delete_directory_modal__WEBPACK_IMPORTED_MODULE_0__
			);
		/* harmony import */ var _components_directory_migration_modal__WEBPACK_IMPORTED_MODULE_1__ =
			__webpack_require__(
				/*! ./components/directory-migration-modal */ './assets/src/js/admin/components/directory-migration-modal.js'
			);
		/* harmony import */ var _components_directory_migration_modal__WEBPACK_IMPORTED_MODULE_1___default =
			/*#__PURE__*/ __webpack_require__.n(
				_components_directory_migration_modal__WEBPACK_IMPORTED_MODULE_1__
			);
		/* harmony import */ var _components_import_directory_modal__WEBPACK_IMPORTED_MODULE_2__ =
			__webpack_require__(
				/*! ./components/import-directory-modal */ './assets/src/js/admin/components/import-directory-modal.js'
			);
		/* harmony import */ var _components_import_directory_modal__WEBPACK_IMPORTED_MODULE_2___default =
			/*#__PURE__*/ __webpack_require__.n(
				_components_import_directory_modal__WEBPACK_IMPORTED_MODULE_2__
			);
		// Scrips
		...
		function updateButtonText(text) {
			$(
				'.directorist_generate_ai_directory .directorist_generate_ai_directory__text'
			).html(text);
		}

		// Update Directory Prompt
		function updatePrompt() {
			directoryPrompt = 'I want to create a '
				.concat(directoryType, ' directory')
				.concat(
					directoryLocation ? ' in '.concat(directoryLocation) : ''
				);
			$('#directorist-ai-prompt').val(directoryPrompt);
			$('#directorist-ai-prompt')
				.siblings('.character-count')
				.find('.current-count')
				.text(directoryPrompt.length);
			if (directoryType) {
		...
		function initializeKeyword() {
			...
			var tagListElem = document.getElementById(
				'directorist-box__tagList'
			);
			var newTagElem = document.getElementById('directorist-box__newTag');
			var recommendedTagsElem = document.getElementById(
				'directorist-recommendedTags'
			);
			var recommendedTags = Array.from(
				recommendedTagsElem.getElementsByTagName('li')
			);
			var tagLimitMsgElem = document.getElementById(
				'directorist-tagLimitMsg'
			);
			...
			var updateTagCount = function updateTagCount() {
				tagCountElem.textContent = ''
					.concat(tagList.length, '/')
					.concat(maxFreeTags);
				tagLimitMsgElem.style.display = 'flex';
				recommendedTagsElem.classList.toggle(
					'recommend-disable',
					!canAddMoreTags()
				);
			};
			...
			var updateRecommendedTagsState =
				function updateRecommendedTagsState() {
					recommendedTags.forEach(function (tagElem) {
						var tagText = tagElem.textContent.trim();
						tagElem.classList.toggle(
							'disabled',
							tagList.includes(tagText)
						);
					});
				};
			...
			var renderTagList = function renderTagList() {
				tagListElem.innerHTML = tagList
					.map(function (tag) {
						return '<li>'.concat(
							tag,
							' <span class="directorist-rmTag" style="cursor:pointer;">&times;</span></li>'
						);
					})
					.join('');
				tagListElem.appendChild(
					newTagElem.parentNode ||
						document.createElement('li').appendChild(newTagElem)
				);
			...
			tagListElem.addEventListener('click', function (e) {
				if (e.target.classList.contains('directorist-rmTag')) {
					var index = Array.from(tagListElem.children).indexOf(
		...
		function initializeProgressBar(finalProgress) {
			if (finalProgress) {
				$(
					'#directorist-create-directory__generating .directory-img #directory-img__generating'
				).hide();
				$(
					'#directorist-create-directory__generating .directory-img #directory-img__building'
				).show();
				$('#directory-generate-btn__content__text').html(
			...
			var generateBtnWrapper = document.querySelector(
				'.directory-generate-btn__wrapper'
			);
			var btnPercentage = document.querySelector(
				'.directory-generate-btn__percentage'
			);
			...
			if (generateBtnWrapper) {
				...
				var updateProgress = function updateProgress() {
					if (creationCompleted) {
						...
						btnPercentage.textContent = ''.concat(
							currentWidth,
							'%'
						);
			...
			var steps = document.querySelectorAll(
				'.directory-generate-progress-list li'
			);
				...
				if (steps.length > 0) {
					steps.forEach(function (step, index) {
						...
						if (progress >= stepThreshold) {
							...
							step.querySelector('.progress-icon').style.display =
								'none';
							step.querySelector('.default-icon').style.display =
								'none';
						} else if (
							progress < stepThreshold &&
							progress >= stepThreshold - 100 / steps.length
						) {
		...
		function initializeDropdownField() {
			...
			var accordion = true;
			$('#directorist-create-directory__ai-fields .fields-count').html(
				dropdowns.length
			);
			var pinnedIconSVG =
						...
						if (accordion) {
							dropdowns.forEach(function (otherDropdown) {
								if (otherDropdown !== dropdown) {
									...
									var otherIcon = otherDropdown.querySelector(
										'.directorist-ai-generate-dropdown__header-icon'
									);
									otherDropdown.setAttribute(
										'aria-expanded',
										false
									);
									if (otherContent) {
			...
			function findAllPinnedItems() {
				var pinnedElements = document.querySelectorAll(
					'.directorist-ai-generate-box__item.pinned'
				);
				if (pinnedElements.length > 0) {
					var titles = Array.from(pinnedElements).flatMap(
						function (pinnedElement) {
							return Array.from(
								pinnedElement.querySelectorAll(
		...
		function initialStepContents() {
			...
			$(
				'.directorist-create-directory__content__items[data-step="1"]'
			).show();
			$(
				'.directorist-create-directory__step .step-count .total-step'
			).html(totalStep);
			$(
				'.directorist-create-directory__step .step-count .current-step'
			).html(1);
			$('#directorist-ai-prompt')
				.siblings('.character-count')
				.find('.max-count')
				.text(maxPromptLength);
			var $directoryName = $(
				'.directorist-create-directory__content__input[name="directory-name"]'
			);
			var $directoryLocation = $(
				'.directorist-create-directory__content__input[name="directory-location"]'
			);
		...
		function handlePromptStep(response) {
			$(
				'.directorist-create-directory__content__items[data-step="2"]'
			).hide();
			$(
				'.directorist-create-directory__content__items[data-step="3"]'
			).show();
			$('.directorist-create-directory__back__btn').hide();
			$('#directorist-recommendedTags').empty().html(response);
			initializeKeyword();
			updateStepTitle(
				'Select relevant keywords to <br /> optimize AI-generated content'
			);
			updateStepDescription(
				'Keywords helps AI to generate relevant categories and fields'
			);
		...
		function handleKeywordStep() {
			...
			$('.directorist-create-directory__content').toggleClass(
				'full-width'
			);
		...
		function handleGenerateFields(response) {
			...
			$('.directorist-create-directory__content').removeClass(
				'full-width'
			);
			$('#directorist-ai-generated-fields-array').val(
				JSON.stringify(
					response === null ||
						response === void 0 ||
		...
		function handleCreateDirectory(redirect_url) {
			$('#directorist-create-directory__preview-btn').removeClass(
				'disabled'
			);
			$('#directorist-create-directory__preview-btn').attr(
				'href',
				redirect_url
			);
			$(
				'#directorist-create-directory__generating .directory-title'
			).html('Your directory is ready to use');
		...
		function handleAIFormResponse(response) {
			...
			if (
				...
				$(
					'.directorist-create-directory__content__items[data-step="' +
						currentStep +
						'"]'
				).hide();
				$(
				...
				$(
					'.directorist-create-directory__step .atbdp-setup-steps li:nth-child('.concat(
						nextStep,
						')'
					)
				).addClass('active');
		...
		$('body').on(
			'click',
			'.directorist_generate_ai_directory',
			function (e) {
				e.preventDefault();
				if (currentStep == 1) {
					$('.directorist-create-directory__back__btn').removeClass(
						'disabled'
					);
					$(
						'.directorist-create-directory__content__items[data-step="1"]'
					...
					$(
						'.directorist-create-directory__step .atbdp-setup-steps li:nth-child(2)'
					).addClass('active');
					...
					$('.directorist-create-directory__header').hide();
					$('.directorist-create-directory__content__footer').hide();
					$('.directorist-create-directory__content').addClass(
						'full-width'
					);
					$('#directorist-create-directory__preview-btn').addClass(
						'disabled'
					);
					$(
						'#directorist-create-directory__generating .directory-title'
					).html('Directory AI is Building your directory... ');
					$(
						'#directorist-create-directory__generating .directory-description'
					).html(
						"We're using your infomation to finalize your directory fields."
					);
				...
				axios
					...
					.catch(function (error) {
						...
						if (
							((_error$response$data = error.response.data) ===
								null || _error$response$data === void 0
								? void 0
								: _error$response$data.success) === false &&
							((_error$response$data2 = error.response.data) ===
								null ||
							_error$response$data2 === void 0 ||
							(_error$response$data2 =
								_error$response$data2.data) === null ||
							_error$response$data2 === void 0
								? void 0
								: _error$response$data2.code) ===
								'limit_exceeded'
						) {
							alert(
								"🙌 You've exceeded the request/site beta limit."
							);
						}
						handleCreateButtonEnable();
		...
		$('body').on('click', '.directorist_regenerate_fields', function (e) {
			...
			axios
				...
				.catch(function (error) {
					...
					if (
						((_error$response$data3 = error.response.data) ===
							null || _error$response$data3 === void 0
							? void 0
							: _error$response$data3.success) === false &&
						((_error$response$data4 = error.response.data) ===
							null ||
						_error$response$data4 === void 0 ||
						(_error$response$data4 = _error$response$data4.data) ===
							null ||
						_error$response$data4 === void 0
							? void 0
							: _error$response$data4.code) === 'limit_exceeded'
					) {
						alert(
							"🙌 You've exceeded the request/site beta limit."
						);
