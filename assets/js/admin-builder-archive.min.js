!(function () {
	var e = {
				...
				e.exports = function (e) {
					return new Promise(function (t, r) {
						...
						if (
							...
							var _ =
								(e.withCredentials || d(v)) && e.xsrfCookieName
					...
					t('.cptm-import-directory-form').on('submit', function (r) {
						...
						try {
							for (p.s(); !(u = p.n()).done; ) {
								...
								f.name.length &&
									(l.includes(f.type) &&
										c.append(f.name, t(f).val()),
									'file' === f.type &&
										c.append(f.name, f.files[0]));
							}
						} catch (e) {
							p.e(e);
						} finally {
			...
			8015: function (e, t, r) {
				...
				(c.Axios = o),
					...
					(c.Cancel = r(1928)),
					(c.CancelToken = r(3191)),
					(c.isCancel = r(3864)),
					(c.all = function (e) {
						return Promise.all(e);
					}),
					(c.spread = r(7980)),
					(c.isAxiosError = r(5019)),
					(e.exports = c),
					(e.exports.default = c);
			},
			9012: function (e) {
	...
	(r.n = function (e) {
		...
		(function () {
			'use strict';
			r(9791), r(3886), r(6585);
			var e = jQuery,
				t = r(2505).default;
			window.addEventListener('load', function () {
				e('.directorist_directory_template_library').on(
					'click',
					function (r) {
						r.preventDefault();
						var n = this;
						e(n)
							...
							.addBack()
							.addClass('disabled'),
							e('.cptm-create-directory-modal__action').after(
							...
							.then(function (t) {
								!(function (t) {
									...
									if (
										...
										return (
											e('.directorist_template_notice')
												.addClass(
													'cptm-section-alert-success'
												)
												.text(a),
											void location.reload()
										);
				...
				e(
					...
					(p = function () {
						(n.innerHTML = r
							...
							a.classList.toggle('recommend-disable', !u()),
							(l = [].concat(r));
					}),
					(f = function (e) {
						e && !r.includes(e) && u() && (r.push(e), p());
					}),
			...
			e('body').on(
				...
				e('body').on(
					...
					function (r) {
						...
						3 == i
							...
							_();
						var n = new FormData();
						n.append('action', 'directorist_ai_directory_creation'),
							n.append('name', o),
							n.append('prompt', c),
							n.append('keywords', l),
							n.append('fields', u),
				...
				e('body').on(
					...
					function (r) {
						...
						var i = new FormData();
						i.append('action', 'directorist_ai_directory_creation'),
							i.append('name', o),
							i.append('prompt', c),
							i.append('keywords', l),
							i.append('pinned', p),
