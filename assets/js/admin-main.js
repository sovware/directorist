...
window.addEventListener('DOMContentLoaded', function () {
  ...
  $('.type-at_biz_dir').each(function (id, element) {
    var findElmCount = $(element).find('.directorist_listing-count-text'); // Store old count value

    var countWrapper = $(element).find('.directorist_listing-count-text');
    var oldCountVal = countWrapper.attr('data-value');
    var validCount = !isNaN(countWrapper.attr('data-value')) ? countWrapper.attr('data-value') : ''; // Count Edit
    ...
    $(element).find('.directorist_listing-count-formText-add').on('click', function (e) {
      ...
      var update_count = $('.directorist-count-text-' + count_id).text();
    ...
    $(element).find('.directorist_listing-count-formText-remove').on('click', function (e) {
      e.preventDefault();
      var thisClosestSibling = $(this).closest('.directorist-listing-count-edit-wrap').siblings('.directorist_listing-count-text');
