/******/ (function () {
  ...
  \*********************************************/
	...
	jQuery(document).ready(function ($) {
		...
		var handleSetupWizardTypeChange =
			function handleSetupWizardTypeChange() {
				var setupWizardCheckedTypeCount = Array.from(
					setupWizardTypes
				).filter(function (checkbox) {
					return checkbox.checked;
				}).length;
				setupWizardSelectedTypeCount.textContent =
					setupWizardCheckedTypeCount;
				setupWizardTypesMaxCount.textContent =
					setupWizardTypesMaxAllowed;
