...
(function ($) {
  ...
  */
    ...
    $.ajax({
      ...
      success: function success(html) {
        if (html.directory_type) {
          ...
          Object(_category_custom_fields__WEBPACK_IMPORTED_MODULE_4__["default"])($);
        }
  ...
  function buildFormDataWithoutRequired() {
    ...
    Object.entries(form_data).forEach(function (_ref9) {
      var _ref0 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default()(_ref9, 2),
        key = _ref0[0],
        value = _ref0[1];
  ...
  */
  ...
  window.addEventListener('directorist-color-changed', Object(_global_components_debounce__WEBPACK_IMPORTED_MODULE_3__["default"])(function (e) {
