!(function () {
	var t = {
			393: function () {
				...
				(t = jQuery),
					window.addEventListener('load', function () {
						var e = null;
						t('.directorist-profile-uploader').length &&
							(e = new EzMediaUploader({
								containerClass: 'directorist-profile-uploader',
							})).init(),
							t('#user_profile_form').on('submit', function (r) {
								r.preventDefault();
								var i = t('#update_user_profile');
								i.attr('disabled', !0),
									i.addClass('directorist-loader');
								var o = new FormData();
								if (
									(o.append('action', 'update_user_profile'),
									o.append(
										'directorist_nonce',
			...
			550: function () {
				...
				!(function () {
					this.DashTab = function (e) {
						(this.globalSetup = function () {
							window.isInitializedDashTab ||
								((window.isInitializedDashTab = !0),
							...
							(this.activateNavLinkByURL = function () {
								...
								if (i.length > 1) {
									var o = i[0];
									(r = JSON.parse(JSON.stringify(i))).splice(
										0,
										1
									),
							...
							document.querySelector(e) &&
								(this.navLinksSetup(e), this.globalSetup());
					};
				})();
			},
			1691: function () {
				var t;
				(t = jQuery)('#display_author_email').length &&
					t('#display_author_email').select2(),
					window.addEventListener('load', function () {
						t('#user_preferences').on('submit', function (e) {
							e.preventDefault();
							var r = t('#update_user_preferences');
							r.attr('disabled', !0),
								r.addClass('directorist-loader');
							var i = new FormData();
							i.append('action', 'update_user_preferences'),
								i.append(
									'directorist_nonce',
									directorist.directorist_nonce
								);
								...
								t.ajax({
									...
									success: function (e) {
										r.removeAttr('disabled'),
											r.removeClass('directorist-loader'),
											e.success
												? t(
						...
						document
							...
							.forEach(function (t, e) {
								(t.style.display = 'none'),
									...
									t
										.querySelector('a.at-modal-close')
										.addEventListener(
											'click',
											function (e) {
												e.preventDefault(),
					...
					window.addEventListener('load', function () {
						t(
							...
							t(window)
								.bind('resize', function () {
									t(this).width() <= 1199 &&
										...
										t('.directorist-shade').removeClass(
											'directorist-active'
										));
								})
								.trigger('resize'),
							t(
								...
								t('.directorist-user-dashboard__nav').addClass(
									'directorist-dashboard-nav-collapsed'
								),
									t('.directorist-shade').removeClass(
										'directorist-active'
							...
							t('.directorist-tab__nav__link').on(
								'click',
								function () {
									t('#user_profile_form').width() < 800 &&
										0 !== t('#user_profile_form').width() &&
										t('#user_profile_form').addClass(
			...
			3818: function () {
				...
				(t = jQuery),
					window.addEventListener('load', function () {
						...
						var r = !1;
						t('.close-announcement').on('click', function (e) {
								...
								t.ajax({
									...
									beforeSend: function () {
										t(a).html(
											...
											t(a).addClass('disable'),
											t(a).attr('disable', !0);
									},
									success: function (e) {
										(r = !1),
											t(a).removeClass('disable'),
											t(a).attr('disable', !1),
											e.success
												? (t(
														'.announcement-id-' + i
			...
			5091: function () {
				...
				(t = jQuery),
					window.addEventListener('load', function () {
						t('.directorist-become-author').on(
							'click',
							function (e) {
								e.preventDefault(),
									t(
							...
							t('.directorist-become-author-modal__cancel').on(
								'click',
								function (e) {
									e.preventDefault(),
										t(
							...
							t('.directorist-become-author-modal__approve').on(
								'click',
								function (e) {
									e.preventDefault();
									var r = {
										userId: t(this).attr('data-userId'),
										nonce: t(this).attr('data-nonce'),
			...
			5753: function () {
				...
				(t = jQuery),
					window.addEventListener('load', function () {
						t('.directorist-user-dashboard__toggle__link').on(
							'click',
							function (e) {
								e.preventDefault(),
									t(
									...
									e.preventDefault(),
										t(this).hasClass(
											...
											: !t(this).parents(
												...
												t('.atbd-dash-nav-dropdown')
													.siblings('ul')
													.slideUp();
								}
							),
							t(window).innerWidth() < 1199 &&
								(t(
									'.directorist-tab__nav__link:not(.atbd-dash-nav-dropdown)'
								).on('click', function () {
									t(
								...
								t(
									...
									e.preventDefault(),
										t('.directorist-shade').toggleClass(
											'directorist-active'
										);
								}));
					});
			...
			7765: function () {
				...
				(t = jQuery),
					window.addEventListener('load', function () {
						...
						t('.directorist-dashboard-listing-nav-js a').on(
							'click',
							function (r) {
								var i = t(this);
								return (
							...
							t('.directorist-dashboard-listings-tbody').on(
								'click',
								'.directorist-dashboard-listing-actions a[data-task]',
								function (r) {
									var i = t(this).data('task'),
										o = t(this).closest('tr').data('id'),
										n = t(
							...
							t('.directorist-dashboard-pagination').on(
								'click',
								'a',
								function (r) {
							...
							t('#directorist-dashboard-listing-searchform').on(
								'submit',
								function (r) {
									var i = t(
											'.directorist-dashboard-listing-nav-js a.directorist-tab__nav__active'
				...
				t('.directorist-dashboard-listings-tbody').on(
					...
					function (e) {
						e.preventDefault(),
							...
							t('.directorist-dropdown-menu').removeClass(
								'active'
							),
							t(this)
					...
					t(document).bind('click', function (e) {
						t(e.target)
							...
							t('.directorist-btn-more').removeClass('active'));
					});
			}),
			r(3183),
			r(3818),
