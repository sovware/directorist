					...
					if (
						...
						if (
							...
							if (icon_class.indexOf('fa-file-pdf') !== -1) {
								iconPath =
									'font-awesome/svgs/solid/file-pdf.svg';
							} else if (
								icon_class.indexOf('fa-file-archive') !== -1
							) {
								iconPath =
									'font-awesome/svgs/solid/file-archive.svg';
							} else if (
								icon_class.indexOf('fa-file-word') !== -1
							) {
								iconPath =
									'font-awesome/svgs/solid/file-word.svg';
							} else if (
								icon_class.indexOf('fa-file-alt') !== -1
							) {
								iconPath =
									'font-awesome/svgs/regular/file-alt.svg';
							} else if (
								icon_class.indexOf('fa-file-excel') !== -1
							) {
								iconPath =
									'font-awesome/svgs/solid/file-excel.svg';
							} else if (
								icon_class.indexOf('fa-file-video') !== -1
							) {
								iconPath =
									'font-awesome/svgs/solid/file-video.svg';
							} else if (
								icon_class.indexOf('fa-file-audio') !== -1
							) {
								iconPath =
									'font-awesome/svgs/solid/file-audio.svg';
							} else if (
							...
							iconURL =
								directorist.assets_url + 'icons/' + iconPath;
						}
