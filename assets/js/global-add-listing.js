...
/* harmony import */ var _components_directorist_modal_alert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/directorist-modal-alert */ "./assets/src/js/components/directorist-modal-alert.js");
...
$('body').on('click', '.directorist-form-social-fields__remove', function (e) {
  ...
  e.preventDefault();
  Object(_components_directorist_modal_alert__WEBPACK_IMPORTED_MODULE_1__["directoristModalAlert"])({
...
if (!localized_data.is_admin) {
  ...
  var createTag = localized_data.create_new_tag; // console.log($('#at_biz_dir-tags').attr("data-max"));
