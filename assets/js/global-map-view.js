...
function initObserver() {
  ...
  var targetNode = document.querySelector('.directorist-archive-contents'); // Create an observer instance linked to the callback function

  var observer = new MutationObserver(initMap); // Start observing the target node for configured mutations
...
function initMap() {
  ...
  (function ($) {
    ...
    setup_map();
    setup_info_window(); // window.addEventListener('load', setup_map);
