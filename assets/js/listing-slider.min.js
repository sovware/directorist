			...
			(document
				...
				.forEach(function (e, i) {
					...
					(r.forEach(function (e, t) {
						e.classList.add(
							'directorist-swiper__nav--prev-listing-'.concat(t)
						);
					}),
						s.forEach(function (e, t) {
							e.classList.add(
								'directorist-swiper__nav--next-listing-'.concat(
									t
								)
							);
						}),
						n.forEach(function (e, t) {
							e.classList.add(
								'directorist-swiper__pagination--listing-'.concat(
									t
								)
							);
						}),
					...
					.forEach(function (i, r) {
						...
						(s.forEach(function (e, t) {
							return e.classList.add(
								'directorist-swiper__nav--prev-related-'.concat(
									t
								)
							);
						}),
							n.forEach(function (e, t) {
								return e.classList.add(
									'directorist-swiper__nav--next-related-'.concat(
										t
									)
								);
							}),
							a.forEach(function (e, t) {
								return e.classList.add(
									'directorist-swiper__pagination--related-'.concat(
										t
									)
								);
							}),
							...
							(n !== p &&
								(function (e) {
									...
									var s = {
										slidesPerView: c,
										spaceBetween: t(
											parseInt(i.dataset.swMargin),
											30
										),
										loop: e,
										slidesPerGroup: t(
											parseInt(i.dataset.swPerslide),
											1
										),
										navigation: {
									...
									('true' ===
										t(i.dataset.swAutoplay, 'false') &&
										(s.autoplay = {
											delay: t(
												parseInt(i.dataset.swSpeed),
												500
											),
											disableOnInteraction: !1,
											pauseOnMouseEnter: !0,
										...
										(u = new Swiper(
											'.directorist-swiper-related-listing-'.concat(
												r
											),
											s
										)));
				...
				document
					...
					.forEach(function (e, t) {
						...
						if (
							...
							f && v.length > 1 && (f.style.display = 'block'),
							d &&
								((d.dir = '0' !== s ? 'rtl' : 'ltr'),
							...
							if (
								((d.style.backgroundColor = n || 'transparent'),
								'1' === o)
							)
								g();
							else {
...
>>>>>>> 3abd89d235be9c71344f5510d65d6184e2dd0194
