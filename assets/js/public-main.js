...
/* harmony import */ var _directorist_modal_alert__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../directorist-modal-alert */ "./assets/src/js/components/directorist-modal-alert.js");
...
(function ($) {
  ...
  $('.directorist-dashboard-listings-tbody').on('click', '.directorist-dashboard-listing-actions-js a[data-task]', function (event) {
    ...
    if (task == 'delete') {
      Object(_directorist_modal_alert__WEBPACK_IMPORTED_MODULE_0__["directoristModalAlert"])({
      ...
      $('#directorist-remove-listing-ok').on('click', function () {
        directorist_dashboard_listing_ajax($activeTab, paged, search, task, postid); // show success message
...
/***/ "./assets/src/js/components/directorist-alert.js":
/*!*******************************************************!*\
  !*** ./assets/src/js/components/directorist-alert.js ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./assets/src/js/components/directorist-dropdown.js":
/*!**********************************************************!*\
  !*** ./assets/src/js/components/directorist-dropdown.js ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./assets/src/js/components/directorist-modal-alert.js":
/*!*************************************************************!*\
  !*** ./assets/src/js/components/directorist-modal-alert.js ***!
  \*************************************************************/
/*! exports provided: directoristModalAlert */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "directoristModalAlert", function() { return directoristModalAlert; });
function directoristModalAlert(data) {
  var alertModalElement = document.querySelector('.directorist-modal-alert');
  ...
  var alertModalContent = "\n        <div class=\"directorist-modal__dialog\">\n\n            <div class=\"directorist-modal__content\">\n\n                <div class=\"directorist-modal__body directorist-text-center directorist-modal-alert-".concat(data.type, "\">\n\n                    <div class=\"directorist-modal-alert-icon\">\n\n                        <i class=\"").concat(iconClass, "\"></i>\n\n                    </div>\n\n                    <div class=\"directorist-modal-alert-text\">\n\n                        <h3 class=\"directorist-modal-alert-text__title directorist-text-").concat(data.type, "\">").concat(data.title, "</h3>\n                        \n                        <p class=\"directorist-modal-alert-text__details\">").concat(data.text, "</p>\n\n                    </div>\n                    \n                </div>\n\n                <div class=\"directorist-modal__footer directorist-text-center").concat(data.action ? ' directorist-modal-alert-action' : '', "\">\n\n\t\t\t\t\t<button class=\"directorist-btn directorist-btn-danger directorist-modal-close directorist-modal-close-js\">Cancel</button>\n\n\t\t\t\t\t<button class=\"directorist-btn directorist-btn-info directorist-modal-close-js\" id=\"").concat(data.okButtonUniqueId, "\">Yes, Delete It!</button>\n\n\t\t\t\t</div>\n\n            </div>\n\n        </div>\n    ");
...
/***/ "./assets/src/js/components/directorist-sorting.js":
/*!*********************************************************!*\
  !*** ./assets/src/js/components/directorist-sorting.js ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ "./assets/src/js/components/listingFavourite.js":
/*!******************************************************!*\
  !*** ./assets/src/js/components/listingFavourite.js ***!
  \******************************************************/
/*! no static exports found */
...
/* harmony import */ var _directorist_modal_alert__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../directorist-modal-alert */ "./assets/src/js/components/directorist-modal-alert.js");
...
(function ($) {
  ...
  $("#directorist-review-form").on("submit", function (e) {
    ...
    if (submit_count > 1) {
      // show error message
      Object(_directorist_modal_alert__WEBPACK_IMPORTED_MODULE_1__["directoristModalAlert"])({
...
/* harmony import */ var _components_directorist_sorting__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/directorist-sorting */ "./assets/src/js/components/directorist-sorting.js");
/* harmony import */ var _components_directorist_sorting__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_directorist_sorting__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_directorist_alert__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/directorist-alert */ "./assets/src/js/components/directorist-alert.js");
/* harmony import */ var _components_directorist_alert__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_directorist_alert__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _components_listingFavourite__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/listingFavourite */ "./assets/src/js/components/listingFavourite.js");
/* harmony import */ var _components_listingFavourite__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_components_listingFavourite__WEBPACK_IMPORTED_MODULE_12__);
...
/* harmony import */ var _components_directorist_dropdown__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/directorist-dropdown */ "./assets/src/js/components/directorist-dropdown.js");
/* harmony import */ var _components_directorist_dropdown__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_components_directorist_dropdown__WEBPACK_IMPORTED_MODULE_15__);
