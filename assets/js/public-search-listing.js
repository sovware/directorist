...
(function ($) {
  ...
  function adsFormReset(searchForm) {
    ...
    var directoristSelect = searchForm.querySelectorAll('.directorist-select:not(.directorist-search-category)');
    ...
    var select2Fields = $(searchForm).find('.select2-hidden-accessible');
