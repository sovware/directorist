			...
			function T(t, e) {
				...
				if (0 !== e) {
					...
					var n = e[0] + e[1],
						i = t.spectrum.xVal[0];
					if (
						n / (t.spectrum.xVal[t.spectrum.xVal.length - 1] - i) >
						1
					)
						throw new Error(
			...
			function W(e, n, s) {
						...
						(function (e, r, i) {
							var o,
								...
								l =
									...
									(o[t.PipsType.LargeValue] =
										n.cssClasses.valueLarge),
									(o[t.PipsType.SmallValue] =
								...
								u =
									...
									(s[t.PipsType.LargeValue] =
										n.cssClasses.markerLarge),
									(s[t.PipsType.SmallValue] =
				...
				function Z(t, e) {
					if (!e.handleNumbers.some(_)) {
						...
						(i.push.apply(i, s.concat(a, l)),
							t.cursor &&
								((O.style.cursor = getComputedStyle(
									t.target
								).cursor),
				...
				function ct(t, e, r) {
					...
					((e = void 0 === e || e),
						n.animate &&
							!o &&
							a(E, n.cssClasses.tap, n.animationDuration),
						A.forEach(function (t) {
							at(t, ut(i[t], t), !0, !1, r);
						}));
				...
				(p((b = E), n.cssClasses.target),
					0 === n.dir
						? p(b, n.cssClasses.ltr)
						: p(b, n.cssClasses.rtl),
					0 === n.ort
