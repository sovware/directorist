      ...
      $.ajax({
        ...
        success: function success(response) {
          if (response) {
            ...
            initSearchFields();
            Object(_components_category_custom_fields__WEBPACK_IMPORTED_MODULE_4__["default"])($);
          }
    ...
    function init_map_api_field() {
      if (directorist.i18n_text.select_listing_map === 'google') {
        ...
        input_fields.forEach(function (field) {
          ...
          $(field.input_elm).on('keyup', Object(_global_components_debounce__WEBPACK_IMPORTED_MODULE_1__["default"])(function (event) {
            event.preventDefault();
        ...
        if (sliderRadiusActive) {
          ...
          if (customNumberParams && customNumberParams !== '0-0') {
            var _customNumberParams$s = customNumberParams.split('-').map(Number),
              _customNumberParams$s2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_customNumberParams$s, 2),
