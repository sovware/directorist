				...
				window.addEventListener('load', function () {
					...
					(e('body').removeClass('directorist-preload'),
						...
						document
							...
							.forEach(function (t) {
								p(e(t).closest('.directorist-search-field'));
							}),
						e('body').on(
							'input keyup change',
							'.directorist-search-field__input:not(.directorist-search-basic-dropdown)',
							function (t) {
								p(e(this).closest('.directorist-search-field'));
							}
						),
						e('body').on(
							'focus blur',
						...
						e('body').on(
							...
							function (t) {
								...
								var r = e(this).closest(
									...
									o = e(this).attr('data-listing_type'),
									s = r.find(
										'.directorist-listing-type-selection__link--current'
									);
								(s.length &&
						...
						(c = document.querySelector(
							...
							new MutationObserver(f).observe(c, {
								attributes: !0,
							}),
						f(),
						e('body').on(
