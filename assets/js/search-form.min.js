	...
	!(function () {
		...
		function u() {
			...
			([
				...
				h(d(d({}, { taxonomy: 'tags' }), e)));
		}
		function p(t) {
			h(d(d({}, { taxonomy: 'categories' }), t));
		}
		function f(t) {
			h(d(d({}, { taxonomy: 'locations' }), t));
		}
		function h(t) {
			if (
				(t = d(d({}, { selector: '', url: '', taxonomy: 'tags' }), t))
					.selector
			) {
				var e = l(t.selector),
		...
		(window.addEventListener('load', u),
			...
			window.addEventListener('directorist-instant-search-reloaded', u),
			r(3563),
			r(8883),
			r(5386));
		var _ = (function () {
			...
			(function (e) {
				window.addEventListener('load', function () {
					function r() {
						e('.directorist-btn-ml').each(function (t, r) {
							var i = e(r).siblings(
								...
								o = e(i).find('.directorist-checkbox');
							(e(o).slice(4, o.length).fadeOut(),
								o.length <= 4 && e(r).css('display', 'none'));
						});
					}
					function i(t) {
						var r = e(t).closest('.directorist-search-field'),
							i = e(t).closest(
								'.directorist-search-basic-dropdown-content'
							),
							o = i.find(
					...
					function v() {
						...
						var t = e('.directorist-radius_search_based_on').val(),
							r = e(
								'address' === t
					...
					(e('body').removeClass('directorist-preload'),
						...
						e(
							...
							var t = e(this),
								r = t.val(),
								i = t.closest('.directorist-search-field');
						...
						e('.wp-color-picker, .directorist-color-picker').each(
							function () {
								var t = e(this).val();
								if (t && '' !== t) {
									var r = e(this)
									...
									r.length && r.css('background-color', t);
								}
							}
						),
						e('body').on(
						...
						e('body').on('click', function (t) {
							...
							r.length ||
								(i.each(function () {
									e(this).removeClass('input-is-focused');
								}),
								o.each(function () {
									e(this)
										.removeClass(
						...
						document
							...
							.forEach(function (t) {
								h(e(t).closest('.directorist-search-field'));
							}),
						e('body').on(
							'input keyup change',
							'.directorist-search-field__input:not(.directorist-search-basic-dropdown)',
							function (t) {
								h(e(this).closest('.directorist-search-field'));
							}
						),
						e('body').on(
							'focus blur',
						...
						e('body').on(
							...
							function (t) {
								...
								var r = e(this).closest(
									...
									i = e(this).attr('data-listing_type'),
									o = r.find(
										'.directorist-listing-type-selection__link--current'
									);
								(o.length &&
