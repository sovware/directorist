				...
				window.addEventListener('load', function () {
					...
					(t('body').removeClass('directorist-preload'),
						...
						window.addEventListener(
							...
							function (e) {
								...
								if (i && '' !== i) {
									...
									c.hasClass('input-has-value') ||
										c.hasClass('input-is-focused') ||
										c.addClass(
											'input-has-value input-is-focused'
										);
								} else
						...
						document
							...
							.forEach(function (e) {
								h(t(e).closest('.directorist-search-field'));
							}),
						t('body').on(
							'input keyup change',
							'.directorist-search-field__input:not(.directorist-search-basic-dropdown)',
							function (e) {
								h(t(this).closest('.directorist-search-field'));
							}
						),
						t('body').on(
							'focus blur',
						...
						(d = document.querySelector(
							...
							new MutationObserver(v).observe(d, {
								attributes: !0,
							}),
						v(),
						t('body').on(
