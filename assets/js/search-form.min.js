	...
	!(function () {
		...
		function o(t) {
			for (var r = 1; r < arguments.length; r++) {
				...
				r % 2
					? s(Object(i), !0).forEach(function (r) {
							e(t, r, i[r]);
						})
			...
			[
				...
				return (function (t) {
					var e = i(t),
						...
						s = e.find('option');
					s.length &&
						s[0].textContent.length &&
						(r.placeholder = s[0].textContent),
				...
				l(o(o({}, { taxonomy: 'tags' }), e));
		}
		function a(t) {
			l(o(o({}, { taxonomy: 'categories' }), t));
		}
		function d(t) {
			l(o(o({}, { taxonomy: 'locations' }), t));
		}
		function l(t) {
			if (
				(t = o(o({}, { selector: '', url: '', taxonomy: 'tags' }), t))
					.selector
			) {
				var e = n(t.selector),
				...
				var p = 1,
					f = {
						...
						templateResult: function (t) {
							if (!t.id) return t.text;
							var e = n(t.element).attr('data-icon'),
								r = t.text,
								i = r.match(/^\s+/),
								s = i ? i[0].length : 0;
							r = r.trim();
				...
				window.addEventListener('load', function () {
					function e() {
						t('.directorist-btn-ml').each(function (e, r) {
							var i = t(r).siblings(
								...
								s = t(i).find('.directorist-checkbox');
							t(s).slice(4, s.length).fadeOut(),
								s.length <= 4 && t(r).css('display', 'none');
						});
					}
					function r() {
						document
					...
					function i(t) {
						...
						if (
							...
							r && r.classList.add('reset-btn-disabled');
						}
					}
					function s(t) {
						...
						e && e.classList.remove('reset-btn-disabled');
					}
					var o, n, c;
					function a(e) {
						e
								...
								.forEach(function (t) {
									!(function (t) {
										...
										s
											? ((r.value = '0'),
												(i.value = o),
												e.directoristCustomRangeSlider.set(
													[0, o]
												))
											: (e.directoristCustomRangeSlider.set(
													[0, 0]
					...
					function f() {
						t('.directorist-range-slider-wrap')
							...
							t('.directorist-location-js').each(function (e, r) {
								'' === t(r).val()
									? t(r)
											.closest(
								...
								if (s && !s.directoristCustomRangeSlider) {
									...
									null ===
										...
										null ===
											...
											void 0 === i ||
											i.on('update', function (e, r) {
												var i = e[r];
												0 === r
													? (d.value = Math.round(i))
													: (l.value = Math.round(i));
												var s = d.value + '-' + l.value;
												(u.value = s),
													p && (p.innerHTML = s),
													f &&
														(f.setAttribute(
					...
					t('body').removeClass('directorist-preload'),
						...
						e(),
						window.addEventListener('triggerSlice', e),
						t('body').on(
							'click',
							'.directorist-btn-ml',
							function (e) {
						...
						document
							...
							.forEach(function (e) {
								l(t(e).closest('.directorist-search-field'));
							}),
						t('body').on(
							'input keyup change',
							'.directorist-search-field__input:not(.directorist-search-basic-dropdown)',
							function (e) {
								l(t(this).closest('.directorist-search-field'));
							}
						),
						t('body').on(
							'focus blur',
						...
						t('body').on(
							...
							function (e) {
								...
								var i = t(this).closest(
									...
									s = t(this).attr('data-listing_type'),
									o = i.find(
										'.directorist-listing-type-selection__link--current'
									);
								o.length &&
						...
						(o = document.querySelector(
							...
							new MutationObserver(f).observe(o, {
								attributes: !0,
							}),
						f(),
						t('body').on(
