			...
			19677: function () {
				...
				((t = jQuery),
					window.addEventListener('load', function () {
						(t('#directorist-report-abuse-form').on(
							'submit',
							function (e) {
								if (
									(t(
							...
							t('#atbdp-report-abuse-form').removeAttr(
								'novalidate'
							),
							t('.directorist-contact-owner-form').on(
								'submit',
								function (e) {
									e.preventDefault();
									var i = t(this),
						...
						function i(t) {
							if (t && e.has(t)) {
								...
								r &&
									...
									(i.nextSibling && r.contains(i.nextSibling)
							...
							[
								{
									...
									value: function () {
										var t = setTimeout(function () {
											(e('.directorist-review-container')
												.length &&
												e(document).off(
													'submit',
													'#commentform'
