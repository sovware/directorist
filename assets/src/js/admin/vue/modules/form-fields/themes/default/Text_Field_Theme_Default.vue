<template>
    <div class="cptm-form-group" :class="formGroupClass">
        ...
        <input class="cptm-form-control" :class="formControlClass" v-if="( typeof filteredValue !== 'object' ) ? true : false" :type="input_type" :value="filteredValue" :placeholder="placeholder" :disabled="disable" @input="$emit('update', $event.target.value)">
