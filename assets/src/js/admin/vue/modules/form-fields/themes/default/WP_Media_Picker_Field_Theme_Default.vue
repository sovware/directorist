<template>
    <div class="cptm-form-group cptm-preview-image-upload cptm-preview-image-upload--show">
        ...
        <div class="cptm-thumbnail">
            ...
            <label class="cptm-upload-btn cptm-btn cptm-btn-dark directorist-row-tooltip" data-tooltip="Change image" data-flow="bottom">
                <i class="uil uil-top-arrow-to-top"></i>
                <input type="button" @click.prevent="openMediaPicker" :value="theButtonLabel">
            </label>
            <div class="cptm-thumbnail-drag-text">or drag and drop image here</div>
