(function ($) {
    ...
    $("body").on("click", '.directorist-filter-btn', function (e) {
        ...
        if (count % 2 === 0) {
            $(e.currentTarget).closest('.directorist-content-active').find('.directorist-search-float').find('.directorist-advanced-filter').css({
                visibility: 'hidden',
                opacity: '0',
                height: '0',
                transition: '.3s ease'
    ...
    $("body").on("click", ".directorist-filter-btn", function (e) {
        e.preventDefault();
        $(e.currentTarget).closest('.directorist-content-active').find('.directorist-search-slide').find('.directorist-advanced-filter').slideToggle().show();
