...
function selec2_add_custom_dropdown_toggle_button() {
    ...
    if ( ! dropdown.length ) {
        ...
        const dropdownHTML = `<span class="directorist-select2-addon directorist-select2-dropdown-toggle"><i class="directorist-icon-mask" style="--directorist-icon:url(${directorist.assets_url}icons/font-awesome/svgs/solid/chevron-down.svg);"></i></span>`;
...
function selec2_add_custom_close_button(field) {
    ...
    // Add
    addon_container.prepend( `<span class="directorist-select2-addon directorist-select2-dropdown-close"><i class="directorist-icon-mask" style="--directorist-icon:url(${directorist.assets_url}icons/font-awesome/svgs/solid/times.svg);"></i></span>` );
