...
function selec2_add_custom_dropdown_toggle_button() {
    ...
    if ( ! dropdown.length ) {
        ...
        const dropdownHTML = `<span class="directorist-select2-addon directorist-select2-dropdown-toggle"><i class="directorist-icon-mask"><span style="--directorist-icon:url(${directorist.assets_url}icons/font-awesome/svgs/solid/chevron-down.svg);"></span></i></span>`;
