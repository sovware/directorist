...
(function ($) {
	...
	function initAddListingMap() {
			...
			$(elm).on(
				...
				debounce(function (event) {
					...
					const blockedKeyCodes = [
						16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 37, 38, 39, 40,
						45, 91, 93, 112, 113, 114, 115, 116, 117, 118, 119, 120,
						121, 122, 123, 144, 145,
					];
					...
					const locationAddressField = $(this).parent(
		...
		$('.directorist-location-js').on('keyup', function (event) {
			...
			if (
				$('#directorist.atbd_wrapper .address_result ul li a').length >
				0
			) {
				$(
					'#directorist.atbd_wrapper .address_result ul li a'
