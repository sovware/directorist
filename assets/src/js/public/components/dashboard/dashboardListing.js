	...
	window.addEventListener('load', () => {
		...
		function directorist_dashboard_listing_ajax(
			...
			$.ajax({
				...
				success: function success(response) {
					$('.directorist-dashboard-listings-tbody').html(
						response.data.content
					);
					$('.directorist-dashboard-pagination').html(
						response.data.pagination
					);
					$('.directorist-dashboard-listing-nav-js a').removeClass(
		...
		$('.directorist-dashboard-listings-tbody').on(
			...
			function (event) {
				...
				var paged = $('#directorist-dashboard-mylistings-js').data(
					'paged'
				);
				var search = $('#directorist-dashboard-mylistings-js').data(
					'search'
				);
