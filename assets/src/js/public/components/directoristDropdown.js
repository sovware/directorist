(function ($) {
  ...
  window.addEventListener("load", () => {
    /* custom dropdown */
    const atbdDropdown = document.querySelectorAll(
    ...
    if (atbdDropdown !== null) {
      atbdDropdown.forEach(function (el) {
        el.querySelector(
          ...
          if (clickCount % 2 === 1) {
            document
              .querySelectorAll(".directorist-dropdown-select-items")
              .forEach(function (elem) {
                elem.classList.remove("directorist-dropdown-select-show");
              });
            el.querySelector(
              ".directorist-dropdown-select-items",
            ).classList.add("directorist-dropdown-select-show");
          } else {
            document
              .querySelectorAll(".directorist-dropdown-select-items")
              .forEach(function (elem) {
    ...
    if (atbdSelect !== null) {
      atbdSelect.forEach(function (el) {
        el.querySelectorAll(".directorist-dropdown-select-items").forEach(
          function (item) {
    ...
    $("body").on(
      ...
      function (e) {
        ...
        $(this)
          ...
          .children(".directorist-dropdown-toggle__text")
          .html(optionText);
    ...
    $("body").on(
      ...
      function (e) {
        e.preventDefault();
        if (
          !$(this).siblings(".directorist-dropdown__links-js").is(":visible")
        ) {
