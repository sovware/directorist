...
(function (global, factory) {
    ...
    function customRangeOptions(options) {
        ...
        var customRanges = {
            step: { r: false, t: customRangeStep },
            keyboardPageMultiplier: { r: false, t: customRangeKeyboardPageMultiplier },
            keyboardMultiplier: { r: false, t: customRangeKeyboardMultiplier },
            keyboardDefaultStep: { r: false, t: customRangeKeyboardDefaultStep },
            start: { r: true, t: customRangeStart },
            connect: { r: true, t: customRangeConnect },
            direction: { r: true, t: customRangeDirection },
            snap: { r: false, t: customRangeSnap },
            animate: { r: false, t: customRangeAnimate },
            animationDuration: { r: false, t: customRangeAnimationDuration },
            range: { r: true, t: customRangeRange },
            orientation: { r: false, t: customRangeOrientation },
            margin: { r: false, t: customRangeMargin },
            limit: { r: false, t: customRangeLimit },
            padding: { r: false, t: customRangePadding },
            behaviour: { r: true, t: customRangeBehaviour },
            ariaFormat: { r: false, t: customRangeAriaFormat },
            format: { r: false, t: customRangeFormat },
            tooltips: { r: false, t: customRangeTooltips },
            keyboardSupport: { r: true, t: customRangeKeyboardSupport },
            documentElement: { r: false, t: customRangeDocumentElement },
            cssPrefix: { r: true, t: customRangeCssPrefix },
            cssClasses: { r: true, t: customRangeCssClasses },
            handleAttributes: { r: false, t: customRangeHandleAttributes },
        };
        var defaults = {
            connect: false,
            direction: "ltr",
    ...
    function initialize(target, originalOptions) {
        if (!target || !target.nodeName) {
            throw new Error(`directoristCustomRangeSlider: create requires a single element, got: ${target}`);
        }
