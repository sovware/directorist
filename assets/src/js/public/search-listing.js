(function ($) {
    ...
    function adsFormReset(searchForm) {
        ...
        let directoristSelect = searchForm.querySelectorAll('.directorist-select:not(.directorist-search-category)');
        ...
        let select2Fields = $(searchForm).find('.select2-hidden-accessible');
