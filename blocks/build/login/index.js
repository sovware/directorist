...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"category":"directorist-blocks-collection","version":"1.0.0","name":"directorist/user-login","title":"Login","description":"Create user login page and this block only works on login page set from settings.","keywords":["login","registration","sign in","sign up"],"supports":{"html":false},"editorScript":"file:./index.js"}');
...
var Placeholder = function Placeholder() {
  return (0,_functions__WEBPACK_IMPORTED_MODULE_6__.getPlaceholder)('signin');
};
