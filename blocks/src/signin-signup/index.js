	...
	edit( { attributes, setAttributes } ) {
		return (
			<Fragment>
				<InspectorControls>
					<PanelBody
						title={ __( 'Sign-In Settings', 'directorist' ) }
					>
						<TextControl
						...
						<TextControl
							...
							onChange={ ( value ) =>
								setAttributes( { signin_button_label: value } )
							}
						/>
						<TextControl
							label={ __(
								'Sign Up Linking Text',
								'directorist'
							) }
							value={ attributes.signup_linking_text }
							onChange={ ( value ) =>
								setAttributes( { signup_linking_text: value } )
							}
						/>
						<TextControl
							label={ __(
					...
					<PanelBody
						isOpen={ false }
						title={ __( 'Sign-Up Settings', 'directorist' ) }
					>
						<ToggleControl
							label={ __( 'Enable Sign-Up', 'directorist' ) }
							checked={ attributes.registration }
							onChange={ ( value ) =>
								setAttributes( { registration: value } )
							}
						/>
						{ attributes.registration ? (
							<Fragment>
								...
								<TextControl
									...
									onChange={ ( value ) =>
										setAttributes( { signup_label: value } )
									}
								/>
								<TextControl
									label={ __(
					...
					{ attributes.registration ? (
						<Fragment>
							...
							<PanelBody
								title={ __( 'Name Fields', 'directorist' ) }
							>
								<ToggleControl
									label={ __(
							...
							<PanelBody
								title={ __( 'Bio Settings', 'directorist' ) }
							>
								<ToggleControl
									label={ __(
										'Show Bio Field',
								...
								<ToggleControl
									...
									onChange={ ( value ) =>
										setAttributes( { bio_required: value } )
									}
								/>
							</PanelBody>

							<PanelBody
								title={ __( 'Privacy & Terms', 'directorist' ) }
							>
								<ToggleControl
									label={ __(
								...
								<TextControl
									...
									onChange={ ( value ) =>
										setAttributes( { terms_label: value } )
									}
								/>
								<TextControl
									label={ __(
