...
Publish targeted announcements to directory users and their dashboards.

Official catalog: [Directorist Announcement](https://directorist.com/product/directorist-announcement/). Catalog identity checked 2026-09-13.

Canonical investigation baseline: **directorist-announcement / master / 92c16c32b1f6610316b2250ebf68c5f6c2abd717**. Selected the newest visible implementation branch tip, then retained default/development and local file differences for feature-level reconciliation; no branches were merged.

Observed plugin header: `Directorist Announcement` — `2.3` ([directorist-announcement.php:1](https://github.com/sovware/directorist-announcement/blob/92c16c32b1f6610316b2250ebf68c5f6c2abd717/directorist-announcement.php#L1)). Header/tag is an identifier, not source authority or release proof.
...
| --- | --- |
| [publish-target](topics/publish-target.md) | announcement, target users, announcement email |
| [read-state](topics/read-state.md) | unread announcement, announcement badge, dismiss announcement |
