...
Expose Directorist listings in BuddyPress profiles, groups and activity.

Official catalog: [BuddyPress Integration](https://directorist.com/product/directorist-buddypress-integration/). Catalog identity checked 2026-09-13.

Canonical investigation baseline: **directorist-buddypress-integration / master / e63ae3d41639d5ddf4df772f1dbd12136792c8db**. Selected the newest visible implementation branch tip, then retained default/development and local file differences for feature-level reconciliation; no branches were merged.

Observed plugin header: `Directorist - BuddyPress Integration` — `2.0` ([directorist-buddypress-integration.php:1](https://github.com/sovware/directorist-buddypress-integration/blob/e63ae3d41639d5ddf4df772f1dbd12136792c8db/directorist-buddypress-integration.php#L1)). Header/tag is an identifier, not source authority or release proof.
...
| --- | --- |
| [profile-groups](topics/profile-groups.md) | buddypress, profile listings, group listings |
| [activity](topics/activity.md) | buddypress activity, share listing, listing timeline |
