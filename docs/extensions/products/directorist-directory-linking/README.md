...
Link a listing to other listings and expose linked-directory fields and search.

Official catalog: [Multi Directory Linking](https://directorist.com/product/directorist-directory-linking/). Catalog identity checked 2026-09-13.

Canonical investigation baseline: **directorist-directory-linking / alpha / ade10cf1e0303510a7c9ad18a925f0799932ce46**. Selected the newest visible implementation branch tip, then retained default/development and local file differences for feature-level reconciliation; no branches were merged.

Observed plugin header: `Directorist - Directory Linking` — `2.2` ([directorist-directory-linking.php:1](https://github.com/sovware/directorist-directory-linking/blob/ade10cf1e0303510a7c9ad18a925f0799932ce46/directorist-directory-linking.php#L1)). Header/tag is an identifier, not source authority or release proof.
...
| --- | --- |
| [link-selection](topics/link-selection.md) | directory linking, linked listing, multi directory linking |
| [link-search](topics/link-search.md) | linked directory search, linked listing missing |
