...
CASES=[
 ...
 ('ব্যবসার সময় সেভ হচ্ছে না',{'directorist-business-hours'},'schedule'),
 ('রাত ১২টার পরে খোলা দেখায় না',{'directorist-business-hours'},'schedule'),
 ('প্ল্যান ছাড়া বিজনেস আওয়ার দেখাচ্ছে না',{'directorist-business-hours','directorist-pricing-plans'},'entitlements'),
 ('ডিভিতে বিজনেস আওয়ার খালি',{'directorist-business-hours','directorist-divi-integration'},'single-modules'),
 ('সাপ্তাহিক রিপোর্টে শেষ লিস্টিং বারবার',{'directorist-analytics'},'tracking-reports'),
 ('সেভ করা সার্চের ইমেইল আসে না',{'directorist-search-alert'},'alert-delivery'),
 ('উকমার্সের পেমেন্ট হচ্ছে না',{'directorist-woocommerce-pricing-plans'},'orders-subscriptions'),
 ('plan chara business hours dekhay na',{'directorist-business-hours','directorist-pricing-plans'},'entitlements'),
 ('divi te hours khali',{'directorist-business-hours','directorist-divi-integration'},'single-modules'),
 ('saved search er mail ashe na',{'directorist-search-alert'},'alert-delivery'),
 ('gallery image import hocche na',{'directorist-gallery'},'gallery-import'),
 ('claim badge tooltip vul',{'directorist-claim-listing'},'paid-claim-badge'),
]
def main():
