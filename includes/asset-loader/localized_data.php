    ...
    public static function formgent_data() {
        $data = [
            'strings' => [
                ...
                'dashboard_description'         => __( 'Track and manage all your incoming messages', 'directorist' ),
                ...
                'enquiry'                       => __( 'Enquiry', 'directorist' ),
                'listing'                       => __( 'Listing', 'directorist' ),
                'sender'                        => __( 'Sender', 'directorist' ),
                'status'                        => __( 'Status', 'directorist' ),
                'actions'                       => __( 'Actions', 'directorist' ),
                'view'                          => __( 'View', 'directorist' ),
                'send_email'                    => __( 'Send Email', 'directorist' ),
                'mark_as_read'                  => __( 'Mark as read', 'directorist' ),
                'marked_as_read'                => __( 'Marked as read', 'directorist' ),
                'delete'                        => __( 'Delete', 'directorist' ),
                'cancel'                        => __( 'Cancel', 'directorist' ),
                'search_enquiries'              => __( 'Search enquiries...', 'directorist' ),
                'no_results'                    => __( 'No results', 'directorist' ),
                'status_new'                    => __( 'New', 'directorist' ),
                'status_read'                   => __( 'Read', 'directorist' ),
                'confirm_delete_single_item'    => __( 'Are you sure to delete this item?', 'directorist' ),
                'confirm_delete_multiple_items' => __( 'Are you sure to delete %d items?', 'directorist' ),
                'action_cannot_be_undone'       => __( 'This action cannot be undone.', 'directorist' ),
                'enquiry_details'               => __( 'Enquiry Details', 'directorist' ),
                'unknown_listing'               => __( 'Unknown Listing', 'directorist' ),
                'loading_enquiry_details'       => __( 'Loading enquiry details...', 'directorist' ),
                'failed_load_enquiry_details'   => __( 'Failed to load enquiry details', 'directorist' ),
                'regarding_listing'             => __( 'Regarding Listing', 'directorist' ),
                'response_marked_as_read'       => __( 'Response marked as read', 'directorist' ),
                'responses_marked_as_read'      => __( '%d response(s) marked as read.', 'directorist' ),
                'response_deleted_successfully' => __( 'Response deleted successfully.', 'directorist' ),
                'responses_deleted_successfully' => __( '%d response(s) deleted successfully.', 'directorist' ),
                'no_email_address_found'        => __( 'No email address found for this enquiry.', 'directorist' ),
                'your_enquiry_on'               => __( 'Your Enquiry on %s', 'directorist' ),
            ]
        ];
