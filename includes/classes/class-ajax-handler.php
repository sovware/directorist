                ...
                for ($i = $start_loop; $i <= $end_loop; $i++) {
                    ...
                    if ($cur_page > 4) {
                        if (($dot__ == $i)) {
                            $jump = $i - 5;
                            $jump = $jump < 1 ? 1 : $jump;
                            $pag_container .= "<li data-page='$jump' class='atbd-active atbd-page-jump-back' title='".__('Previous 5 Pages', 'directorist')."'><i class='la la-ellipsis-h la_d'></i> <i class='la la-angle-double-left la_h'></i></li>";
                        }
                    }
                    if ($cur_page == $i) {
                    ...
                    if (($cur_page > 4)) {
                        if (($dot_ == $i)) {
                            ...
                            $pag_container .= "<li data-page='$jump' class='atbd-active atbd-page-jump-up' title='".__('Next 5 Pages', 'directorist')."'><i class='la la-ellipsis-h la_d'></i> <i class='la la-angle-double-right la_h'></i></li>";
                        }
                    }
