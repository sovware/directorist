...
if (!class_exists('BD_Categories_Widget')) {
    ...
    class BD_Categories_Widget extends WP_Widget
    {
        ...
        function __construct()
        {
            ...
            parent::__construct(
                'bdcw_widget', // Base ID
                esc_html__('Directorist - Categories', ATBDP_TEXTDOMAIN), // Name
                $widget_options // Args
            );
        }
        ...
        public function form($instance)
        {
            ...
            $title = !empty($instance['title']) ? esc_html($instance['title']) : esc_html__('Categories', ATBDP_TEXTDOMAIN);
            ?>
            <p>
            ...
            if( count( $terms ) > 0 ) {
                ...
                foreach( $terms as $term ) {
                    ...
                    if( ! empty( $settings['hide_empty'] ) || ! empty( $settings['show_count'] ) ) {
                        $count = atbdp_listings_count_by_category( $term->term_id, $settings['pad_counts'] );
