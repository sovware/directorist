...
if (!class_exists('ATBDP_Custom_Post')) :
    ...
    class ATBDP_Custom_Post
    {
        public function __construct()
        {
            ...
            add_filter('quick_edit_custom_box', [$this, 'on_quick_edit_custom_box'], 10, 2);
            add_filter('bulk_edit_custom_box', [$this, 'on_quick_edit_custom_box'], 10, 2);
            add_action('save_post', [$this, 'save_quick_edit_custom_box']);
