...
class Directorist_Multilingual_Polylang {
    public function __construct() {
        ...
        add_filter( 'pll_get_taxonomies', [ $this, 'enable_translation_to_custom_post_types' ], 10, 1 );
    ...
    public function enable_translation_to_custom_post_types( array $post_types ): array {
        $post_types[ ATBDP_POST_TYPE ] = true;
        return $post_types;
    }

    public function enable_translation_to_custom_taxonomies( array $taxonomies ): array {
        $taxonomies[ ATBDP_DIRECTORY_TYPE ] = true;
        $taxonomies[ ATBDP_CATEGORY ]       = true;
        $taxonomies[ ATBDP_LOCATION ]       = true;
        $taxonomies[ ATBDP_TAGS ]           = true;
