...
class Directorist_Category extends Custom_Widget_Base {
	...
	protected function render() {
		...
		$shortcode = sprintf( '[directorist_category header="%1$" header_title="%2$" view="%3$" map_height="%4$" columns="%5$" listings_per_page="%6$" show_pagination="%7$" orderby="%8$" order="%9$" logged_in_user_only="%10$" ]', 
