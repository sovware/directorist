<?php
/**
 * Directorist Phone 2 Field class.
 *
 */
...
class Phone2_Field extends Text_Field {

	public $type = 'phone2';

	public function get_builder_label() : string {
		return esc_html_x( 'Phone 2', 'Builder field label', 'directorist' );
	}
...
Fields::register( new Phone2_Field() );
