...
registerBlockType( 'directorist/listing-contact-information', {
	apiVersion: 2,

	title: __( 'Single Listing Contact Information', 'directorist' ),
	...
	transforms: {
		from: [
			{
				type: 'shortcode',
				tag: 'directorist_listing_contact_information',
				attributes: {}
			},
		]
	},
