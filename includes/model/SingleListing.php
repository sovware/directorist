...
class Directorist_Single_Listing {
	...
	public function get_slider_data() {
		...
		$image_quality = get_directorist_option('slider_image_quality', 'full');
		...
		$data = array(
			...
			'width'              => get_directorist_option('gallery_crop_width', 16),
			'height'             => get_directorist_option('gallery_crop_height', 9),
