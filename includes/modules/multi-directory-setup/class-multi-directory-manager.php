...
class Multi_Directory_Manager {
    ...
    public function run() {
        ...
        add_action( 'wp_ajax_directorist_ai_directory_form_step_two', [ $this, 'directorist_ai_directory_form_step_two' ] );
    }
    ...
    // handle step two
    public function directorist_ai_directory_form_step_two() {
        ...
        $prompt = "$prompt. I need add listing page fields list. Don not add any intro just give me every individual fields within @@ so that I can easily extract. Here is some keywords $keywords. Also add html field type for every field with <type> tag. Give appropriate options for select type fields Don not add something like 'Here is the list of fields for a car directory listing page";
        ...
        foreach ($lines as $line) {
            // Use regex to extract field label and type
