...
if ( ! class_exists( 'ATBDP_Post_Type_Manager' ) ) {
    class ATBDP_Post_Type_Manager {
        // run
        public function run() {
        ...
        public function add_menu_pages() {
            add_submenu_page(
                ...
                'manage_options',
                'atbdp-post-types',
                [ $this, 'menu_page_callback__post_types' ],
                5
            );
        }

        // menu_page_callback__post_types
        public function menu_page_callback__post_types() {
            
            atbdp_load_admin_template( 'cpt-manager/cpt-archive' );
        }
