 ...
 * Init REST api.
 */
namespace Directorist\RestAPI\Version1;
...
function register_controllers() {
    ...
    // Base controller.
    require_once $dir . 'controllers/class-abstract-controller.php';

     // Admin Controller
    require_once "{$dir}controllers/class-admin-controller.php";
    ( new \Directorist\Rest_Api\Controllers\Version1\Admin_Controller() )->register_routes();

    // Listings
    require_once $dir . 'controllers/class-abstract-posts-controller.php';
    require_once $dir . 'controllers/class-listings-controller.php';

    $listings_v1 = new \Directorist\Rest_Api\Controllers\Version1\Listings_Controller();
    $listings_v1->register_routes();

    // Listings actions
    require_once $dir . 'controllers/class-listings-actions-controller.php';
    ...
    // Listing reviews
    require_once $dir . 'controllers/class-listing-reviews-controller.php';
    ...
    require_once $dir . 'controllers/class-abstract-terms-controller.php';
    require_once $dir . 'controllers/class-categories-controller.php';
    require_once $dir . 'controllers/class-tags-controller.php';
    require_once $dir . 'controllers/class-locations-controller.php';
    ...
    // Users controllers.
    require_once $dir . 'controllers/class-users-controller.php';

    $users = new \Directorist\Rest_Api\Controllers\Version1\Users_Controller();
    $users->register_routes();

    // Users favorites controller.
    require_once $dir . 'controllers/class-users-favorites-controller.php';
