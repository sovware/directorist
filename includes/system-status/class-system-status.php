...
class ATBDP_Status
{
    ...
    public function status_menu() {
        add_submenu_page( 'edit.php?post_type=at_biz_dir', __( 'Debug Bar', 'directorist' ),  __( 'Debug Bar', 'directorist' ) , 'manage_options', 'directorist-status', array( $this, 'tools_page' ) );
    }
