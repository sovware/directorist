                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'The homepage URL of your site.', 'directorist' ); ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'The root URL of your site.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'The version of GeoDirectory installed on your site.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'The version of WordPress installed on your site.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'Whether or not you have WordPress Multisite enabled.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'The maximum amount of memory (RAM) that your site can use at one time.', 'directorist' );?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'Displays whether or not WordPress is in Debug Mode.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'Displays whether or not WP Cron Jobs are enabled.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'The current language used by WordPress. Default = English', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                ...
                                <table class="atbds_system-table table-responsive">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'Information about the web server that is currently hosting your site.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'The version of MySQL installed on your hosting server.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'The largest filesize that can be uploaded to your WordPress installation.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'The default timezone for your server.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'Payment gateways can use cURL to communicate with remote servers to authorize payments, other plugins may also use it when communicating with remote services.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'HTML/Multipart emails use DOMDocument to generate inline CSS in templates.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'GZip (gzopen) is used to open the GEOIP database from MaxMind.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'Multibyte String (mbstring) is used to convert character encoding, like for emails or converting characters to lowercase.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'PayPal uses this method of communicating when sending back transaction information.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="atbds_table-pointer">
                                                <span class="atbds_tooltip" data-label="<?php _e( 'Directorist plugin may use this method of communication when checking for plugin updates.', 'directorist' ); ?>">
                                                    <i class="fa fa-question-circle"></i>
                                                    <span class="atbds_tooltip__text"></span>
                                                </span>
                                            </td>
