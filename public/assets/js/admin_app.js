...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapState"])({
    ...
    the_options: function the_options() {
    ...
    hasOptionsSource: function hasOptionsSource() {
      ...
      var terget_field = null;
      var terget_fields = this.optionsSource.where.split('.');
      ...
      if (_typeof(terget_field) !== 'object') {
        return false;
      }

      if (typeof this.optionsSource.value_from !== 'string' && typeof this.optionsSource.label_from !== 'string') {
        return terget_field;
      }
      ...
      var value_from = this.optionsSource.value_from;
      var label_from = this.optionsSource.label_from;

      var _iterator2 = _createForOfIteratorHelper(terget_field),
          _step2;
    ...
    hasInvalidValue: function hasInvalidValue() {
      ...
      var _iterator3 = _createForOfIteratorHelper(this.the_options),
          _step3;
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          ...
          if (typeof option.options !== 'undefined') {
            var _iterator4 = _createForOfIteratorHelper(option.options),
                _step4;

            try {
              for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                var sub_option = _step4.value;
  ...
  methods: {
    ...
    syncValidationWithLocalState: function syncValidationWithLocalState(validation_log) {
      ...
      _c(
        ...
        [
          _vm.default_option
            ...
            : _vm._e(),
          _vm._v(" "),
          _vm._l(_vm.the_options, function(option, option_key) {
            return [
              option.group && option.the_options
                ? [
                    _c(
                      "optgroup",
                      { key: option_key, attrs: { label: option.group } },
                      _vm._l(option.the_options, function(
                        sub_option,
                        sub_option_key
                      ) {
                        return _c(
