...
/* harmony import */ var _Sub_Tab_Packages__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Sub_Tab_Packages */ "./public/assets/src/js/vue/components/cpt-manager/tabs/general/Sub_Tab_Packages.vue");
/* harmony import */ var _Sub_Tab_Other__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Sub_Tab_Other */ "./public/assets/src/js/vue/components/cpt-manager/tabs/general/Sub_Tab_Other.vue");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      active_sub_nav: 0,
      sub_contents: [_Sub_Tab_General__WEBPACK_IMPORTED_MODULE_3__["default"], _Sub_Tab_Packages__WEBPACK_IMPORTED_MODULE_4__["default"], _Sub_Tab_Other__WEBPACK_IMPORTED_MODULE_5__["default"]]
    };
  },
  methods: {}
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    updateSectionData: function updateSectionData(section_key, field_key, value) {
      console.log({
        section_key: section_key,
        field_key: field_key,
        value: value
      });
      this.$store.commit('updateGeneralSectionData', {
        section_key: section_key,
        field_key: field_key,
        value: value
      });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    updatePackagesSectionData: function updatePackagesSectionData(section_key, field_key, value) {
      //console.log(  { section_key, field_key, value } );
      this.$store.commit('updatePackagesSectionData', {
        section_key: section_key,
        field_key: field_key,
        value: value
      });
...
var render = function() {
  ...
  return _c("div", { staticClass: "atbdp-cpt-manager" }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "atbdp-cptm-body" }, [_c("tabContents")], 1),
    _vm._v(" "),
    _c("div", { staticClass: "atbdp-cptm-footer" }, [
      ...
      _c("div", { staticClass: "atbdp-cptm-footer-actions" }, [
        _vm.fotter_actions.prev.show
          ? _c(
              "button",
              {
                staticClass: "atbdp-cptm-btn cptm-btn-secondery",
                attrs: { type: "button" }
              },
              [_vm._v("Prev")]
            )
          : _vm._e(),
        _vm._v(" "),
        _vm.fotter_actions.save.show
          ? _c(
              "button",
              {
                staticClass: "atbdp-cptm-btn cptm-btn-primary",
                attrs: { type: "button" }
              },
              [_vm._v("Save")]
            )
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "atbdp-cptm-tab-item submission-form cptm-tab-content",
      class: _vm.getActiveClass(_vm.index, _vm.active_nav_index)
    },
    [_vm._v("\n    Submission Form\n")]
  )
                  ...
                  _vm._b(
                    {
                      ...
                      on: {
                        update: function($event) {
                          return _vm.updatePackagesSectionData(
                            section_key,
                            field_key,
                            $event
                          )
...
/* harmony import */ var _vue_store_CPT_Manager_Store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vue/store/CPT_Manager_Store */ "./public/assets/src/js/vue/store/CPT_Manager_Store.js");
/* harmony import */ var _vue_components_cpt_manager_CPT_Manager_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vue/components/cpt-manager/CPT_Manager.vue */ "./public/assets/src/js/vue/components/cpt-manager/CPT_Manager.vue");
...
if (cpt_manager_el) {
  ...
  new vue__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    store: _vue_store_CPT_Manager_Store__WEBPACK_IMPORTED_MODULE_2__["default"],
    components: {
      'cpt-manager': _vue_components_cpt_manager_CPT_Manager_vue__WEBPACK_IMPORTED_MODULE_3__["default"]
    }
  });
}
...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  state: {
    ...
    settings: {},
    submenu: {
      general: ['General', 'Packages', 'Other']
    },
    fotter_actions: {
      prev: {
        show: true
