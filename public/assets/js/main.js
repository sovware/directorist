...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        var columnLeft = $(".atbd_col_left.col-md-8");
        var columnRight = $(".directorist.col-md-4");
        var tabColumn = $(".atbd_dashboard_wrapper .tab-content .tab-pane .col-lg-4");
        var w_size = d_wrapper.width();
        if (w_size >= 500 && w_size <= 735) {
            columnLeft.toggleClass("col-md-8");
            columnRight.toggleClass("col-md-4");
        }
        if (w_size <= 600) {
            d_wrapper.addClass("size-xs");
            tabColumn.toggleClass("col-md-4");
        }
