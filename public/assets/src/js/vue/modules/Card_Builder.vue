                    ...
                    <div class="cptm-option-card-header">
                        ...
                        <div class="cptm-option-card-header-nav-section">
                            <ul class="cptm-option-card-header-nav">
                                <li class="cptm-option-card-header-nav-item">
                                    Preset Field
                                </li>
                                <li class="cptm-option-card-header-nav-item">
                                    Custom Field
    ...
    computed: {
        output_data()  {
            ...
            for ( let section in layout ) {
                ...
                if ( typeof layout[ section ] !== 'object' ) { continue; }

                for ( let section_area in layout[ section ] ) {
                    output[ section ][ section_area ] = [];

                    if ( typeof layout[ section ][ section_area ] !== 'object' ) { continue; }
                    if ( typeof layout[ section ][ section_area ].widgets !== 'object' ) { continue; }

                    for ( let widget in layout[ section ][ section_area ].widgets ) {
                        const widget_name = layout[ section ][ section_area ].widgets[ widget ];

                        if ( typeof this.active_widgets[ widget_name ] !== 'object' ) { continue; }
                        if ( typeof this.active_widgets[ widget_name ].options !== 'object' ) { continue; }
