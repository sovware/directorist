  ...
  <div class="cptm-form-builder cptm-row">
      ...
      <div class="cptm-form-builder-active-fields">
        ...
        <div class="cptm-form-builder-active-fields-container">
          ...
          >
            <div class="cptm-form-builder-group-header-section">
              <div class="cptm-form-builder-group-header">
                <div
                  ...
                  draggable="true"
                  @drag="activeGroupOnDragStart(group_key)"
              ...
              <div class="cptm-form-builder-group-fields">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <template
                        v-for="(option, option_key) in getActiveFieldsSettings(
                          field_key,
                          'options'
                        )"
                      >
                  ...
                  <div
                    ...
                    @drop.prevent="
                      activeFieldOnDrop({ field_key, field_index, group_key })
                    "
                  ></div>
                </div>
              </div>
            ...
            <div
              class="cptm-item-footer-drop-area cptm-group-item-drop-area"
              :class="
                group_key === current_drag_enter_group_item ? 'drag-enter' : ''
              "
    ...
    <div class="cptm-col-6" v-if="widget_groups">
      <div
        ...
        v-for="(widget_group, group_key) in widget_groups"
        :key="group_key"
      >
      ...
      for (let widget_group in dependency_widgets) {
        ...
        for (let field in dependency_fields) {
          ...
          if (
            ...
            let dep_field_has_label =
              dependency_fields[field].label &&
              dependency_fields[field].label.length
                ? true
                : false;
            let dep_widget_has_label = dependency_widgets[widget_group].widgets[
              widget_name
            ].options.label
              ? true
              : false;
  ...
  methods: {
    ...
    insertActiveFieldsItem(payload) {
      ...
      if (typeof payload.destination_field_index !== "undefined") {
        ...
        this.groups[payload.destination_group_index].fields.push(
          inserting_field_key
        );
      }
    },
