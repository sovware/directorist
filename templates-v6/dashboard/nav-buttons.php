    ...
    <?php if ( 'general' == $user_type && ! empty( $become_author_button) ) { ?>
        ...
        <div class="directorist-become-author-modal">
            <div class="directorist-become-author-modal__content">
                ...
                <h3><?php _e( 'Are you sure you want to become an author?', 'directorist' ); ?> <br><?php _e( '(It is subject to approval by the admin)', 'directorist' ); ?><span class="directorist-become-author__loader"></></h3>
                <p>
