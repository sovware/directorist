...
<div class="form-group directorist-tag-field">
	...
	<select name="<?php echo esc_attr( $data['field_key'] ); ?>" class="form-control" id="at_biz_dir-tags" multiple="multiple" <?php echo !empty( $data['max'] ) ? 'max="'. $data['max'] .'"' : ''; echo !empty( $data['allow_new'] ) ? 'data-allow_new="'. $data['allow_new'] .'"' : ''; ?> >
		<?php
