	...
	<div class="<?php echo apply_filters('atbdp_add_listing_container_fluid', 'container-fluid'); ?>">
		<ul class="list-inline">
			<?php if( ! empty( $all_types ) ) { ?>
				<li class="list-inline-item <?php echo ( ! empty( $_GET['directory_type'] ) && 'all' == $_GET['directory_type'] ) ? 'current' : ''; ?>"><a class="directorist-listing-types-link" href="<?php echo esc_url( add_query_arg('directory_type', 'all' ) ); ?>"><span class=""></span> <?php _e( 'All', 'directorist' ); ?></a></li>
			<?php } ?>
