            ...
            <div class="directorist-col-md-6 directorist-offset-md-3">
                <div class="atbdp_login_form_shortcode">
					...
					if ( ! empty( $recovery ) ) :
						...
						if ( isset( $_POST['directorist_reset_password'], $_POST['directorist-reset-password-nonce'] ) &&
							'true' == $_POST['directorist_reset_password'] &&
							wp_verify_nonce( sanitize_key( $_POST['directorist-reset-password-nonce'] ), 'reset_password' )
							) :
