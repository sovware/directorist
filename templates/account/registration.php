...
?>
<div class="directorist-registration-wrapper directorist-w-100 directorist-author">
				...
				<div class="add_listing_title atbd_success_mesage directorist-author__message">
					...
					if ( ! empty( $_GET['registration_status'] ) && true == $_GET['registration_status'] ) {
						if ( empty( $display_password_reg ) ) {
							?>
							<p style="padding: 20px" class="alert-success directorist-author__message__text"><?php directorist_icon( 'las la-check' ); ?><?php esc_html_e(' Go to your inbox or spam/junk and get your password.', 'directorist'); ?>
								<?php
						...
						<?php } else { ?>
							...
							<p style="padding: 20px" class="alert-success directorist-author__message__text"><?php directorist_icon( 'las la-check' ); ?><?php esc_html_e(' Registration completed. Please check your email for confirmation.', 'directorist'); ?>
								<?php
					...
					<p style="padding: 20px" class="alert-danger directorist-author__message__text"><?php directorist_icon( 'las la-exclamation-triangle' ); ?> <?php echo wp_kses_post( directorist_get_registration_error_message( sanitize_text_field( wp_unslash( $_GET['errors'] ) ) ) ); ?></p>
					<?php } ?>
				</div>
			</div>
			<div class="directorist-col-md-4 directorist-offset-md-4">
				<div class="directory_register_form_wrap directorist-author__form">
					<form action="<?php the_permalink(); ?>" method="post">
						...
						<?php } ?>
						<div class="directory_regi_btn directorist-mb-15 directorist-author__form__btn-wrapper">
							...
							<?php } ?>
							<button type="submit" class="directorist-btn directorist-btn-primary directorist-author__form__btn" name="atbdp_user_submit"><?php echo esc_html( $reg_signup ); ?></button>
						...
						<div class="directory_regi_btn directorist-author__form__toggle-area">
							<?php echo esc_html( $login_text ); ?> <a href="<?php echo esc_url( $login_url ); ?>"><?php echo esc_html( $log_linkingmsg ); ?></a>
						</div>
						<?php } ?>
					</form>
				</div>
