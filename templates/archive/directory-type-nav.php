	...
	<div class="directorist-type-nav">
		<ul class="directorist-type-nav__list">
			...
			<?php if( ! empty( $all_types ) ) { ?>
				...
				<li class="list-inline-item <?php echo ( $listings->current_listing_type == 'all' || 'all' == $get_current_url_type ) ? 'current' : ''; ?>">

					<a class="directorist-type-nav__link" href="<?php echo esc_url( add_query_arg('directory_type', 'all' ) ); ?>"><span class=""></span> <?php esc_html_e( 'All', 'directorist' ); ?></a>
