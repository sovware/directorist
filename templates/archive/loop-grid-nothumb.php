...
<div class="directorist-listing-single directorist-listing-card directorist-listing-no-thumb <?php echo esc_attr( $listings->loop_wrapper_class() ); ?>">
	...
	<div class="directorist-listing-single__header">
		...
		<div class="directorist-listing-single__header__left">
			<?php $listings->render_card_view($card_view['body']['avatar']); ?>

			<div class="directorist-listing-single__title"><?php $listings->render_card_view($card_view['body']['title']); ?></div>
		</div>

		<div class="directorist-listing-single__header__right">
			<div class="directorist-listing-single__action"><?php $listings->render_card_view($card_view['body']['quick_actions']); ?></div>
		</div>
		
	</div>

	<div class="directorist-listing-single__info"><?php $listings->render_card_view($card_view['body']['quick_info']); ?></div>
