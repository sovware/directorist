            ...
            switch( $field_meta['type'][0] ) {
                ...
                case 'checkbox' :
                    ...
                    foreach( $choices as $choice ) {
                        ...
                        printf( '<div class="custom-control custom-checkbox checkbox-outline checkbox-outline-primary"><input type="checkbox" name="cf[%d][]" id="%d" class="custom-control-input" value="%s"%s><label for="%d" class="custom-control-label">%s</label></div>', $post->ID,$_for, $_value, $_checked,$_for, $_label );
                    }
                    break;
                case 'radio' :
                    $choices = $field_meta['choices'][0];
