...
<div class="nav_button">
	...
	<?php if ( $dashboard->user_type == 'general' ): ?>
		<a href="#" class="btn btn-primary atbdp-become-author" data-nonce="<?php echo wp_create_nonce( 'atbdp_become_author' ); ?>" data-userId="<?php echo get_current_user_id(); ?>"><?php esc_html_e( 'Become an author', 'directorist' ); ?></a>
