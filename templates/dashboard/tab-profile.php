						...
						<div class="directorist-user-info-wrap">
							...
							<div class="directorist-user-socials">
								...
								<div class="directorist-form-group">
									...
									<label for="facebook"><span class="directorist-social-icon"><i class="la la-facebook"></i></span> <?php esc_html_e( 'Facebook', 'directorist' ); ?></label>
								...
								<div class="directorist-form-group">
									...
									<label for="twitter"><span class="directorist-social-icon"><i class="la la-twitter"></i></span><?php esc_html_e( 'Twitter', 'directorist' ); ?></label>
								...
								<div class="directorist-form-group">
									...
									<label for="linkedIn"><span class="directorist-social-icon"><i class="la la-linkedin"></i></span><?php esc_html_e( 'LinkedIn', 'directorist' ); ?></label>
								...
								<div class="directorist-form-group">
									...
									<label for="youtube"><span class="directorist-social-icon"><i class="la la-youtube"></i></span><?php esc_html_e( 'Youtube', 'directorist' ); ?></label>
