						...
						<div class="directorist-user-info-wrap">
							...
							<div class="directorist-user-socials">
								...
								<div class="directorist-form-group">
									...
									<label for="instagram"><span class="directorist-social-icon"><?php directorist_icon( 'lab la-instagram' ); ?></span><?php esc_html_e( 'Instagram', 'directorist' ); ?></label>

									<input id="instagram" class="directorist-form-element" type="url" name="user[instagram]" value="<?php echo esc_attr( $dashboard->user_info( 'instagram' ) ); ?>" placeholder="<?php esc_attr_e( 'Enter your instagram url', 'directorist' ); ?>">
