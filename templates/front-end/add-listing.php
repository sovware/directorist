                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                if($enable_video_url) {?>
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="video_url" name="linsting[videourl]" value="<?= !empty($videourl) ? esc_attr($videourl): ''; ?>" class="form-control directory_field" placeholder="<?= __('Only YouTube & Vimeo URLs.', ATBDP_TEXTDOMAIN); ?>"/>
                                    </div>
                                <?php } ?>
