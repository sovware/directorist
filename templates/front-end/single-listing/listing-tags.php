        ...
        <?php  if(!empty($tags_section_lable)){  ?>
            <div class="atbd_content_module_title_area">
                <div class="atbd_area_title">
                    <h4>
                        <span class="<?php echo apply_filters('atbdp_single_listing_tag_icon', 'la la-tags'); ?>"></span> <?php echo esc_attr( $tags_section_lable ); ?>
                    </h4>
                </div>
        ...
        <div class="atbdb_content_module_contents">
            <ul>
                <?php  foreach ($tags as $tag) {
                    ...
                    $name = $tag->name; ?>
                    <li><a href="<?php echo esc_url($link); ?>"><span class="<?php atbdp_icon_type(true); ?><?php echo apply_filters('atbdp_single_listing_tags_icon', '-tag'); ?>"></span> <?php echo esc_attr($name); ?></a></li>
                <?php } ?>
            </ul>
        </div>
    </div>
