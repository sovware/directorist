                        ...
                        <div class="multistep-wizard__nav">
                            ...
                            foreach ( $form_data as $key => $section ) {
                                ...
                                if ( empty( $listing_type ) && ! empty( $section['fields'] ) ) {
                                    printf( '<a href="#add-listing-content-%s" id="add-listing-nav-%s" class="multistep-wizard__nav__btn">%s %s</a>', esc_attr( $id ), esc_attr( $id ), wp_kses_post( isset( $section['icon'] ) ? directorist_icon( $section['icon'], false ) : directorist_icon( 'fas fa-circle', false ) ), esc_html( $section['label'] ) );
                                }
                            }
                            ?>
