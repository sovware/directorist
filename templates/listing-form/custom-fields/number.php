...
<div class="directorist-form-group directorist-custom-field-number">
	...
	<div class="directorist-form-group__with-prefix">
		<span class="directorist-form-group__prefix directorist-form-group__prefix--start">KM</span>
		...
		<span class="directorist-form-group__prefix directorist-form-group__prefix--end">KM</span>
	</div>
