...
<div class="directorist-form-group directorist-form-map-field">
	...
	<div class="directorist-form-map-field__wrapper">
		...
		<?php if ('google' == $select_listing_map): ?>
			...
			<small class="map_drag_info"><?php directorist_icon( 'fa fa-info-circle' ); ?> <?php esc_html_e('You can drag pinpoint to place the correct address manually.', 'directorist'); ?></small>
