...
<div class="directorist-form-group directorist-form-tag-field">
	...
	<select name="<?php echo esc_attr( $data['field_key'] ); ?>" class="directorist-form-element" id="at_biz_dir-tags" data-selected-id="<?php esc_attr_e( $current_ids_as_string ) ?>" data-selected-label="<?php esc_attr_e( $current_labels_as_string ) ?>"  data-placeholder="<?php echo esc_attr( $placeholder ); ?>" data-max="<?php echo esc_attr( $data_max ); ?>" data-allow_new="<?php echo esc_attr( $data_new ); ?>" <?php echo esc_attr( $multiple ); ?> <?php $listing_form->required( $data ); ?>>
