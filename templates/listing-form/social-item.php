...
<div class="directorist-form-social-fields" id="socialID-<?php echo esc_attr( $id ); ?>">
    ...
    <div class="directorist-form-group directorist-form-social-fields__action">
        <span data-id="<?php echo esc_attr( $id ); ?>" class="directorist-form-social-fields__remove dashicons dashicons-trash" title="<?php esc_attr_e('Remove this item', 'directorist'); ?>"></span>
    </div>
</div>
