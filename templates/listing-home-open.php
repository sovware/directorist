                    ...
                    <div class="row atbdp-search-form">
                        ...
                        if('yes' == $location_field) {
                            ...
                            if('listing_location' == $search_location_address) {
                                ...
                                $search_html .= '<div class="atbdp_get_address_field"><input type="text" id="address" autocomplete="off" name="address" value="'.$address.'" placeholder="'.$address_label.'" class="form-control location-name">'. $geo_loc .'</div>';
                    ...
                    if('yes' == $reset_filters_button || 'yes' == $apply_filters_button) {?>
                        <div class="bdas-filter-actions">
                            <?php if('yes' == $reset_filters_button) { ?>
                                <button type="reset" class="btn btn-outline-primary btn-sm"><?php _e($reset_filters_text, 'directorist');?></button>
