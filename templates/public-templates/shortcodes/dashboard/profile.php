                    ...
                    <div id="user_profile_pic" class="ez-media-uploader" data-type="images" data-min-file-items="0" data-max-file-items="1" data-max-total-file-size="0" data-allow-multiple="0" data-show-alerts="false" data-show-file-size="false" data-featured="false" data-allow-sorting="false" data-show-info="false" data-uploader-type="avater">
                        ...
                        <div class="ezmu__old-files">
                            <?php if (!empty($u_pro_pic)) { ?>
                                <span class="ezmu__old-files-meta" data-attachment-id="<?php echo esc_attr($u_pro_pic_id); ?>" data-url="<?php echo !empty($u_pro_pic) ? esc_url($u_pro_pic[0]) : esc_url(ATBDP_PUBLIC_ASSETS . 'images/no-image.jpg'); ?>" data-type="image"></span>
                            <?php } ?>
                        </div>

                        <div class="ezmu-dictionary">
                            <span class="ezmu-dictionary-label-select-files"><?php _e('Select', 'directorist'); ?></span>
                            <span class="ezmu-dictionary-label-add-more"><?php _e('Select', 'directorist'); ?></span>
                            <span class="ezmu-dictionary-label-change"><?php _e('Change', 'directorist'); ?></span>
                            <span class="ezmu-dictionary-alert-max-total-file-size"><?php _e('Max limit for total file size is __DT__', 'directorist'); ?></span>
                            <span class="ezmu-dictionary-alert-min-file-items"><?php _e('Min __DT__ file is required', 'directorist'); ?></span>
                            <span class="ezmu-dictionary-alert-max-file-items"><?php _e('Max limit for total file is __DT__', 'directorist'); ?></span>
                            <span class="ezmu-dictionary-info-max-total-file-size"><?php _e('Maximum allowed file size is __DT__', 'directorist'); ?></span>
                            <span class="ezmu-dictionary-info-type" data-show='0'></span>
                            <span class="ezmu-dictionary-info-min-file-items"><?php _e('Minimum __DT__ file is required', 'directorist'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-9">
                <div class="atbd_user_profile_edit">
                    ...
                    <div class="user_info_wrap">
                        ...
                        <div class="row row_fu_name">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="full_name" name="user[full_name]" value="<?php echo !empty($c_user->display_name) ? esc_attr($c_user->display_name) : ''; ?>" placeholder="<?php _e('Enter your full name', 'directorist'); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="user_name"><?php _e('User Name', 'directorist'); ?></label>
                                    <input class="form-control" id="user_name" type="text" disabled="disabled" name="user[user_name]" value="<?php echo !empty($c_user->user_login) ? esc_attr($c_user->user_login) : ''; ?>"> <?php _e('(username can not be changed)', 'directorist'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row_email_cell">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="tel" id="phone" name="user[phone]" value="<?php echo esc_attr($u_phone); ?>" placeholder="<?php _e('Enter your phone number', 'directorist'); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row_password">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="new_pass" class="form-control" type="password" name="user[new_pass]" value="<?php echo !empty($new_pass) ? esc_attr($new_pass) : ''; ?>" placeholder="<?php _e('Enter a new password', 'directorist'); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="confirm_pass"><?php _e('Confirm New Password', 'directorist'); ?></label>
                                    <input id="confirm_pass" class="form-control" type="password" name="user[confirm_pass]" value="<?php echo !empty($confirm_pass) ? esc_attr($confirm_pass) : ''; ?>" placeholder="<?php _e('Confirm your new password', 'directorist'); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row_socials">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="facebook" class="form-control" type="url" name="user[facebook]" value="<?php echo esc_attr($facebook); ?>" placeholder="<?php _e('Enter your facebook url', 'directorist'); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <p><?php _e('Leave it empty to hide', 'directorist') ?></p>
                                    <input id="twitter" class="form-control" type="url" name="user[twitter]" value="<?php echo esc_attr($twitter); ?>" placeholder="<?php _e('Enter your twitter url', 'directorist'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <p><?php _e('Leave it empty to hide', 'directorist') ?></p>
                                    <input id="linkedIn" class="form-control" type="url" name="user[linkedIn]" value="<?php echo esc_attr($linkedIn); ?>" placeholder="<?php _e('Enter linkedIn url', 'directorist'); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <p><?php _e('Leave it empty to hide', 'directorist') ?></p>
                                    <input id="youtube" class="form-control" type="url" name="user[youtube]" value="<?php echo esc_attr($youtube); ?>" placeholder="<?php _e('Enter youtube url', 'directorist'); ?>">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary" id="update_user_profile"><?php _e('Save Changes', 'directorist'); ?></button>
