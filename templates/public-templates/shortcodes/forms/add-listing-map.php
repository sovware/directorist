        ...
        <div class="atbdb_content_module_contents">
            ...
            if (empty($display_address_for) && !empty($display_address_field)) { ?>
                <div class="form-group" id="atbdp_address">
                    ...
                    <input type="text" name="address" id="address" autocomplete="off" value="<?php echo !empty($address) ? esc_attr($address) : ''; ?>" class="form-control directory_field" placeholder="<?php echo esc_attr($address_placeholder); ?>"/>
                    ...
                    <div class="map_wrapper">
                        <?php if ('google' == $select_listing_map) { ?>
                            <div id="floating-panel">
                                <button class="btn btn-danger" id="delete_marker"><?php _e('Delete Marker', 'directorist'); ?></button>
                            </div>
                        <?php } ?>
                        ...
                        <div class="cor-wrap">
                            ...
                            <label for="manual_coordinate">
                                <input type="checkbox" name="manual_coordinate" value="1" id="manual_coordinate" <?php echo (!empty($manual_coordinate)) ? 'checked' : ''; ?> > <?php printf(__('Or Enter Coordinates (latitude and longitude) Manually', 'directorist'), $map_guide);?>
                            </label>
                        </div>
                    ...
                    <div class="row">
                        <div id="hide_if_no_manual_cor" class="clearfix">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="manual_lat" id="manual_lat" value="<?php echo !empty($manual_lat) ? esc_attr($manual_lat) : $default_latitude; ?>" class="form-control directory_field" placeholder="<?php esc_attr_e('Enter Latitude eg. 24.89904', 'directorist'); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="manual_lng" id="manual_lng" value="<?php echo !empty($manual_lng) ? esc_attr($manual_lng) : $default_longitude; ?>" class="form-control directory_field" placeholder="<?php esc_attr_e('Enter Longitude eg. 91.87198', 'directorist'); ?>"/>
                                </div>
                            </div>

                            <div class="col-md-3 col-sm-12">
                                <div class="form-group lat_btn_wrap">
                                    <button class="btn btn-primary" id="generate_admin_map"><?php _e('Generate on Map', 'directorist'); ?></button>
                                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group hide-map-option">
                                <input type="checkbox" name="hide_map" value="1" id="hide_map" <?php echo (!empty($hide_map)) ? 'checked' : ''; ?> >
