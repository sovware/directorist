...
<div class="form-group" class="directorist-map-field">
	...
	<?php if ($display_address_field) { ?>
		<div class="form-group">
			<?php $form->add_listing_label_template( $data ); ?>
			<input type="text" name="address" id="address" autocomplete="off" value="<?php echo esc_attr($address); ?>" class="form-control directory_field" placeholder="<?php echo esc_attr( $data['placeholder'] ); ?>"/>
