...
<div class="atbd_listing_action_area">
	...
	<?php if ($enable_social_share): ?>
		<div class="atbd_action atbd_share">
			<span class="<?php echo atbdp_icon_type(); ?>-share"><?php esc_html_e('Share', 'directorist'); ?></span>
	...
	<?php if ( $enable_report_abuse ): ?>
		<div class="atbd_action atbd_report">
			...
			<a href="" data-target="atbdp-report-abuse-modal"><?php esc_html_e('Report', 'directorist'); ?></a>
			<?php else: ?>
				<a href="javascript:void(0)" class="atbdp-require-login"><span class="<?php echo atbdp_icon_type(true); ?>-flag"></span><?php esc_html_e('Report', 'directorist'); ?></a>
			<?php endif; ?>
