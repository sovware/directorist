		...
		foreach ($categories as $category) {
			...
			<div class="<?php echo esc_attr($list_col_class);?>">
				<div class="atbd_category_wrapper">
					<a href="<?php echo esc_url($category['permalink']);?>" class="atbd_parent_cat"><span><?php echo esc_html($category['name']);?></span><?php echo $category['grid_count_html'];?></a><?php echo $plus_icon;?>
					<?php echo $category['subterm_html'];?>
					<?php //echo atbdp_list_categories($categories_settings);?>
				</div>
			</div>
		<?php } ?>
	</div>
