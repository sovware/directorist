...
?>
<div class="directorist atbd_wrapper directory_search_area atbdp-bg-white atbdp-style-meterial single_area ads-advaced--wrapper" style="background-image: url('<?php echo !empty( $bgimg['url'] ) ? esc_url( $bgimg['url'] ) : ''; ?>')">
