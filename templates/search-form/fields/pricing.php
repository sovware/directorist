				...
				<div class="directorist-custom-range-slider__wrap">
					<div class="directorist-custom-range-slider__value">
						<?php if ( !empty($min_placeholder) ): ?>
							<label for="directorist-custom-range-slider__value__min" class="directorist-custom-range-slider__label">
								<?php echo esc_attr( $min_placeholder ); ?>
							</label>
						<?php endif; ?>
						<span class="directorist-custom-range-slider__prefix">$</span>
						<input type="number" placeholder="Min" value="<?php echo esc_attr( $searchform->price_value('min') ); ?>" name="directorist-custom-range-slider__value__min" id="directorist-custom-range-slider__value__min" class="directorist-custom-range-slider__value__min">
					</div>
					<div class="directorist-custom-range-slider__value">
						<?php if ( !empty($max_placeholder) ): ?>
							<label for="directorist-custom-range-slider__value__max" class="directorist-custom-range-slider__label">
								<?php echo esc_attr( $max_placeholder ); ?>
							</label>
						<?php endif; ?>
						<span class="directorist-custom-range-slider__prefix">$</span>
						<input type="number" placeholder="Max" value="<?php echo esc_attr( $searchform->price_value('max') ); ?>" name="directorist-custom-range-slider__value__max" id="directorist-custom-range-slider__value__max" class="directorist-custom-range-slider__value__max">
					</div>
					<input type="hidden" name="directorist-custom-range-slider-[<?php echo esc_attr( $data['field_key'] ); ?>]" id="directorist-custom-range-slider__range" class="directorist-custom-range-slider__range" value="<?php echo esc_attr( $searchform->price_value('max') ); ?> - <?php echo esc_attr( $searchform->price_value('max') ); ?>">
				</div>
			</div>
		<?php endif; ?>
