...
$ptype = $search_form->get_pricing_type();
...
<div class="directorist-search-field">
	...
	<div class="directorist-price-ranges">
		...
		<?php if ( $ptype == 'both' || $ptype == 'price_unit' ): ?>
			...
			<div class="directorist-price-ranges__item directorist-form-group"><input type="text" name="price[0]" class="directorist-form-element" placeholder="<?php echo esc_attr( $min_placeholder ); ?>" value="<?php echo esc_attr( $search_form->price_value('min') ); ?>"></div>
			<div class="directorist-price-ranges__item directorist-form-group"><input type="text" name="price[1]" class="directorist-form-element" placeholder="<?php echo esc_attr( $max_placeholder ); ?>" value="<?php echo esc_attr( $search_form->price_value('max') ); ?>"></div>
