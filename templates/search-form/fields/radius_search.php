...
<div class="directorist-search-field">
	...
	<div class="directorist-range-slider-wrap">
		<div class="directorist-range-slider" data-default-radius="<?php echo esc_attr( $default_distance ); ?>" data-slider-minValue="<?php echo esc_attr( $value ); ?>" data-slider-unit="<?php echo esc_attr( $searchform->range_slider_unit( $data ) );?>"></div>
