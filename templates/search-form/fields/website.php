...
<div class="directorist-search-field directorist-form-group">
	...
	<input class="directorist-form-element" type="text" name="<?php echo esc_attr( $data['field_key'] ); ?>" value="<?php echo esc_attr( $value ); ?>" placeholder="" <?php echo ! empty( $data['required'] ) ? 'required="required"' : ''; ?>>
