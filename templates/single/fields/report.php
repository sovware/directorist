...
<div class="directorist-single-listing-action directorist-action-report directorist-tooltip directorist-btn-modal directorist-btn-modal-js atbdp-require-login" data-directorist_target="directorist-report-abuse-modal" aria-label="<?php esc_html_e( 'Report', 'directorist' ); ?>">
