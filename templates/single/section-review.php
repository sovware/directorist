				...
				<div class="directorist-card__body directorist-review-area">
					<form action="#" id="directorist-review-form" method="post">
						...
						<div class="directorist-form-group directorist-form-group-review-text">
							<textarea name="content" id="review_content" class="directorist-form-element" cols="20" rows="5" placeholder="<?php echo esc_attr( $review_placeholder ); ?>"><?php echo esc_html( stripslashes( $review_content ) ); ?></textarea>
						</div>
