    ...
    <div class="directorist-widget-listing">
        ...
        if ( $featured_listings->have_posts() ) {
            while ( $featured_listings->have_posts() ) {
                ...
                $listing_reviews = get_post_meta( $listing_id, '_directorist_reviews', true );
                ...
                <div class="directorist-widget-listing__single">
                    ...
                    <div class="directorist-widget-listing__content">
                        <h4 class="directorist-widget-listing__title"><a href="<?php echo esc_url( get_post_permalink( $listing_id) ); ?>"><?php echo esc_html( stripslashes( get_the_title() ) ); ?></a></h4>
