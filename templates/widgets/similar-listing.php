...
<div class="atbd_categorized_listings">
  <ul class="listings">
    <?php foreach ($related_listings->posts as $related_listing) : ?>
      ...
      <li>
        <div class="atbd_left_img">
          <?php if ( empty( $disable_single_listing ) ) {
            printf( '<a href="%s">', esc_url( get_post_permalink( $related_listing->ID ) ) );
          }
          ...
          <div class="directorist-listing-category">
            ...
            ?>
              <a href="<?php echo esc_url($term_link); ?>">
                <?php directorist_icon($term_icon); ?><?php echo esc_html($term_label); ?>
              </a>
              <?php
