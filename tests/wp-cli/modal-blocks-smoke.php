...
if ( $administrator ) {
    ...
    $logged_in_avatar  = '<!-- wp:directorist/account-button --><div class="wp-block-directorist-account-button"><button type="button" class="wp-block-button__link wp-element-button"></button></div><!-- /wp:directorist/account-button -->';
