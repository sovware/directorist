	...
	<div class="directorist-create-directory__wrapper">
		...
		<div class="directorist-create-directory__content">
			...
			<div class="directorist-create-directory__content__items">
				<div class="directorist-box">
					...
					<div class="directorist-box__item">
						...
						<div class="directorist-create-directory__go-pro" id="directorist-proTagMsg"
							style="display: none;">
			...
			<div class="directorist-create-directory__generate">
				<div class="directory-img">
					<svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42" fill="none">
						<path
							...
							stroke="url(#paint0_linear_5920_1562)" stroke-width="1.5" stroke-linejoin="round" />
						<path
							...
							stroke="url(#paint1_linear_5920_1562)" stroke-width="1.5" stroke-linejoin="round" />
						<defs>
							<linearGradient id="paint0_linear_5920_1562" x1="27" y1="1" x2="27" y2="29"
								gradientUnits="userSpaceOnUse">
								<stop stop-color="#6E89F7" />
				...
				<div class="directory-generate-btn__wrapper" data-width="30">
					<div class="directory-generate-btn--bg" style="width: 30%;">
					...
					<div class="directory-generate-btn__content">
						<svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
							<path
								...
								fill="url(#paint0_linear_5661_2975)" />
							<defs>
						...
						Fields are being generated... <span class="directory-generate-btn__percentage">30%</span>
					</div>
				</div>
			</div>
