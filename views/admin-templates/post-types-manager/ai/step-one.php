            ...
            <div class="directorist-create-directory__content__items">
                <div class="directorist-create-directory__content__form-group">
                    <label for="business-name">
                        Enter your business name <span style="color: red;">*</span>
                    </label>
                    <div class="directorist-create-directory__contentinput-group">
                        <span class="directorist-create-directory__content__input-icon">📝</span>
                        <input
                            type="text"
                            id="business-name"
                            class="form-control"
                    ...
                    <label for="business-location">
                        Your business location <span class="text-muted">(optional)</span>
                    </label>
                    <div class="directorist-create-directory__content__input-group">
                        <span class="input-icon">📍</span>
                        <select id="business-location" class="form-control">
                ...
                <div class="directorist-create-directory__back">
                    <a href="<?php echo esc_url( wp_get_referer() ) ?>" class="directorist-create-directory__back__btn">
                        <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13 5L8 10L13 15" stroke="#141B34" stroke-width="1.5" stroke-miterlimit="16"/>
                        </svg>
                        Back
                    </a>
                </div>
