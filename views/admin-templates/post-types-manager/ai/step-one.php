<div class="directorist-create-directory">
	...
	<div class="directorist-create-directory__wrapper">
		...
		<div class="directorist-create-directory__content">
			...
			<div class="directorist-create-directory__content__items">
                ...
                <div class="directorist-create-directory__content__form-group">
                    ...
                    <div class="directorist-create-directory__content__input-group">
                        ...
                        <textarea class="form-control directorist-create-directory__content__input --textarea" name="" id="tell-us" placeholder="Tell AI about your business to get better AI-powered suggestions...">I want to create a </textarea>
                    </div>
                </div>
            </div>
			...
			<div class="directorist-create-directory__content__items">
                <div class="directorist-create-directory__content__form-group">
                    <label class="directorist-create-directory__content__form-group-label" for="select-keywords">
                        Select keywords
                    </label>
