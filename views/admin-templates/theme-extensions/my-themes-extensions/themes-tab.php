    ...
    <div class="theme-card-wrapper">
        <div class="theme-card">
            ...
            <div class="theme-card__footer">
                ...
                <a href="#" class="theme-update-btn" data-target="<?php echo esc_attr( $args['current_active_theme_info']['stylesheet'] ); ?>"><?php echo esc_html( $args['is_beta'] ? 'Update Beta' : 'Update' ); ?></a>
            </div>
            <?php endif;?>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-primary"><?php echo esc_html( $args['is_beta'] ? 'Update Beta' : 'Update' ); ?></button>
                                </div>
                            </div>
                        </div>
